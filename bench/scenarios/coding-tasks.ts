...
const tasks: Task[] = [
  {
    ...
    description:
      'Write a function that removes duplicate elements from an array while preserving order.',
    domain: 'coding',
  ...
  return [...new Set(arr)];
    ...
    successCriteria: (result) => {
      ...
      return (
        (code.includes('set') || (code.includes('filter') && code.includes('indexof'))) &&
  ...
  },
  {
    ...
    description:
      'Write a function that creates a deep clone of an object, handling nested objects and arrays.',
    domain: 'coding',
  ...
  },
  {
    ...
    description:
      'Write a debounce function that delays execution until after a specified wait time has elapsed.',
    domain: 'coding',
  ...
  },
  {
    ...
    description:
      'Write a function that retries a promise-returning function up to N times with exponential backoff.',
    domain: 'coding',
  ...
  },
  {
    ...
    description:
      'Write a binary search function that finds the index of a target in a sorted array.',
    domain: 'coding',
  ...
  },
  {
    ...
    description:
      'Write a throttle function that limits function execution to once per specified interval.',
    domain: 'coding',
...
export const codingTasksScenario: BenchmarkScenario = {
  ...
  domain: 'coding',
  tasks,
  metrics: ['success_rate', 'token_efficiency', 'latency', 'memory_usage', 'learning_velocity'],
};
