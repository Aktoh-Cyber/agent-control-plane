...
const tasks = [
  {
    ...
    description:
      'Design a RESTful API for user authentication including signup, login, logout, and token refresh.',
    domain: 'api-design',
    input: `Design endpoints for user authentication system with JWT tokens.`,
    successCriteria: (result) => {
      const output = result.output.toLowerCase();
      return (
        (output.includes('post') && output.includes('/auth/signup')) ||
  ...
  },
  {
    ...
    description:
      'Design a RESTful API for managing blog posts with proper HTTP methods and status codes.',
    domain: 'api-design',
    input: `Design CRUD endpoints for blog posts including listing, creating, updating, and deleting.`,
    successCriteria: (result) => {
      const output = result.output.toLowerCase();
      return (
        (output.includes('get') && output.includes('post') && output.includes('put')) ||
  ...
  },
  {
    ...
    description:
      'Design pagination for a large dataset with cursor-based or offset-based pagination.',
    domain: 'api-design',
  ...
  },
  {
    ...
    description:
      'Design rate limiting strategy for API with appropriate headers and error responses.',
    domain: 'api-design',
  ...
  },
  {
    ...
    description:
      'Design consistent error response format with proper status codes and error details.',
    domain: 'api-design',
