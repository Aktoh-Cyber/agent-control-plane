  ...
  "agents": {
    "reasoningbank": {
      "memoryConfig": {
        ...
        "gamma": 0.2, // Reliability weight
        "delta": 0.1 // Diversity weight
      }
    }
  }
}
...
- Check database has memories: `npx agent-control-plane reasoningbank status`
...
- Review memory quality: `npx agent-control-plane reasoningbank list`
...
- Test retrieval: `npx agent-control-plane reasoningbank list --query="implement debounce"`
...
- [agent-control-plane Documentation](../README.md)
- [ReasoningBank CLI Guide](../agent-control-plane/src/reasoningbank/README.md)
