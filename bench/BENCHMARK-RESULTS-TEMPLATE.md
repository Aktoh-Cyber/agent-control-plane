...
4. Check memory quality (`npx agent-control-plane reasoningbank list`)
...
1. Check memories are being created (`npx agent-control-plane reasoningbank status`)
2. Verify retrieval is working (`npx agent-control-plane reasoningbank list --query="test"`)
