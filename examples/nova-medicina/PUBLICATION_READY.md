...
Nova Medicina is an AI-powered medical analysis system with anti-hallucination safeguards, designed as a supplement to professional healthcare. Built on top of agent-control-plane, it provides evidence-based medical analysis with strict safety measures.
...
- [Agentic-flow](https://github.com/Aktoh-Cyber/agent-control-plane) - Multi-agent AI coordination
- [AgentDB](https://github.com/ruvnet/agentdb) - Vector database for learning
- [Claude-flow](https://github.com/tafyai/gendev) - AI orchestration
