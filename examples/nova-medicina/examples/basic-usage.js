...
async function understandingConfidenceScores() {
  ...
  try {
    ...
    console.log(
      ...
      (confidenceResult.breakdown.diagnosisConfidence * 100).toFixed(1) + '%'
    );
    ...
    console.log(
      '2. Citation Quality:',
      (confidenceResult.breakdown.citationQuality * 100).toFixed(1) + '%'
    );
    ...
    console.log(
      ...
      (confidenceResult.breakdown.knowledgeBaseValidation * 100).toFixed(1) + '%'
    );
    ...
    console.log(
      ...
      (confidenceResult.breakdown.contradictionCheck * 100).toFixed(1) + '%'
    );
    ...
    console.log(
      ...
      (confidenceResult.breakdown.providerAlignment * 100).toFixed(1) + '%'
    );
    ...
    if (confidenceResult.overall >= 0.9) {
    ...
    } else if (confidenceResult.overall >= 0.5) {
