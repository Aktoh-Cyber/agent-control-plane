  ...
  try {
    ...
    const review = {
      ...
      modifications: {
        ...
        additionalTests: ['Complement levels', 'Renal function tests'],
      },
    };
    ...
    console.log(
      'New Confidence:',
      (reviewResult.updatedAnalysis.diagnosis.confidence * 100).toFixed(1) + '%'
    );
...
async function example5_BatchProcessing() {
  ...
  try {
    ...
    const avgConfidence =
      successful.reduce((sum, r) => sum + r.confidenceScore.overall, 0) / successful.length;
