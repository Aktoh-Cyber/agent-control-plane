...
export function showMainHelp(): void {
  ...
  console.log(
    chalk.cyan('  2.') +
      ' Analyze symptoms:     ' +
      chalk.green('nova-medicina analyze "chest pain, shortness of breath"')
  );
  console.log(
    chalk.cyan('  3.') +
      ' Verify with AI:       ' +
      chalk.green('nova-medicina verify <analysis-id>')
  );
  console.log(
    chalk.cyan('  4.') +
      ' Notify providers:     ' +
      chalk.green('nova-medicina provider notify <analysis-id>')
  );
  ...
  console.log(
    chalk.cyan('    nova-medicina --tutorial') + chalk.gray('  (Interactive tutorial mode)\n')
  );
...
export function showVerifyHelp(): void {
  console.log(chalk.bold.cyan('\n✓ VERIFY COMMAND\n'));
  console.log(
    chalk.gray('Verify analysis using multiple AI models for consensus and confidence scoring.\n')
  );
  ...
  console.log(
    chalk.red('    Below 60%'),
    chalk.gray('Low - Significant disagreement (recommend human review)\n')
  );
...
export function showConfigHelp(): void {
  ...
  console.log(
    chalk.dim('    nova-medicina provider add --name "Dr. Smith" --email "dr.smith@clinic.com"\n')
  );
  ...
  const steps = [
    ...
    },
    {
      ...
      content:
        ...
        chalk.green(
          '  nova-medicina provider notify abc123def456 \\\n' +
            '    --urgent \\\n' +
            '    --request-callback\n\n'
        ) +
        "They'll receive:\n" +
...
export function showProviderContacts(providers: any[]): void {
  ...
  if (providers.length === 0) {
    ...
    console.log(
      chalk.cyan('  nova-medicina provider add --name "Dr. Smith" --email "dr.smith@clinic.com"\n')
    );
    return;
  }
    ...
    console.log(
      boxen(
        chalk.bold.cyan(`${provider.name}`) +
          ...
          '\n\n' +
          (provider.specialty
            ? chalk.gray('Specialty: ') + chalk.white(provider.specialty) + '\n'
            : '') +
