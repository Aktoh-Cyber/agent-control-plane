...
const RESEARCH_PHASES = {
  ...
  2: { name: 'Deep Analysis', timePercent: 0.4, depthMultiplier: 1.2 },
  3: { name: 'Verification', timePercent: 0.2, depthMultiplier: 0.8 },
  4: { name: 'Citation Verification', timePercent: 0.15, depthMultiplier: 0.6 },
  5: { name: 'Synthesis', timePercent: 0.1, depthMultiplier: 0.5 },
};
```
...
_ED2551: Where depth meets accuracy in AI-powered research._
