 ...
 * Based on agent-control-plane MCP architecture
 */
...
import { createJob, getJobStatus, getJobs, initDatabase, updateProgress } from './db-utils.js';
...
const GITHUB_URL = 'https://github.com/Aktoh-Cyber/agent-control-plane';
