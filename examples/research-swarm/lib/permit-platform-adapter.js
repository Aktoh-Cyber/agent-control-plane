...
import { SupabaseFederationAdapter } from '../node_modules/agent-control-plane/dist/federation/integrations/supabase-adapter.js';
import { createJob, markComplete, updateProgress } from './db-utils.js';
...
export class PermitPlatformAdapter {
  ...
  getMetrics() {
    const avgLatency =
      this.metrics.syncLatency.length > 0
