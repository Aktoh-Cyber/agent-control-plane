...
- `/home/user/agent-control-plane/examples/deepseek-agent-demo.sh` - Full demo script
- `/home/user/agent-control-plane/examples/deepseek-simple-test.sh` - Quick test
- `/home/user/agent-control-plane/examples/deepseek-direct-api.js` - Direct API test
- `/home/user/agent-control-plane/examples/deepseek-agent-guide.md` - Complete guide
- `/home/user/agent-control-plane/examples/deepseek-config.json` - Configuration reference
- `/home/user/agent-control-plane/examples/DEEPSEEK_AGENT_EXAMPLES.md` - This file
...
- **Agentic-Flow**: https://github.com/Aktoh-Cyber/agent-control-plane
