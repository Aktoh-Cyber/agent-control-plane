...
- **Node.js**: 18+ (for agent-control-plane)
- **npm**: 9+
- **Git**: 2.30+
...
### Step 3: Install agent-control-plane
...
### Step 4: Install GenDev

```bash
# Install GenDev alpha version
...
Automatically store predictions using GenDev hooks:
