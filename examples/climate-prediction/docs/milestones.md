...
npx gendev@alpha hooks pre-task --description "Project foundation setup"
npx gendev@alpha hooks post-edit --file "Cargo.toml" --memory-key "climate/foundation/workspace"
npx gendev@alpha hooks post-task --task-id "milestone-1"
```
...
npx gendev@alpha hooks post-edit --file "docs/architecture.md" --memory-key "climate/arch/system"
npx gendev@alpha hooks post-edit --file "docs/api-contracts.ts" --memory-key "climate/arch/api"
npx gendev@alpha hooks post-edit --file "docs/database-schema.sql" --memory-key "climate/arch/db"
```
...
npx gendev@alpha hooks pre-task --description "Rust core engine development"
npx gendev@alpha hooks post-edit --file "crates/climate-core/src/prediction.rs" --memory-key "climate/impl/engine"
npx gendev@alpha hooks post-task --task-id "milestone-3"
...
npx gendev@alpha hooks pre-task --description "Data processing pipeline"
npx gendev@alpha hooks post-edit --file "crates/climate-data/src/pipeline.rs" --memory-key "climate/impl/pipeline"
npx gendev@alpha hooks post-task --task-id "milestone-4"
```
...
```bash
npx gendev@alpha hooks pre-task --description "Node.js API development"
npx gendev@alpha hooks post-edit --file "packages/api/src/routes/predictions.ts" --memory-key "climate/impl/api"
npx gendev@alpha hooks post-task --task-id "milestone-5"
```
...
_[Content truncated for length - includes Python model training, ONNX export, Rust inference integration, model versioning, A/B testing framework]_
...
_[Content includes continuous learning loop, pattern recognition, model improvement, feedback processing, cross-session memory]_
...
_[Content includes comprehensive testing strategy, load testing, security testing, performance benchmarking]_
...
_[Content includes Docker containerization, Kubernetes orchestration, CI/CD setup, monitoring]_
...
_[Content includes production deployment, user documentation, API guides, training materials]_
...
_ReasoningBank enabled for continuous learning and improvement_
