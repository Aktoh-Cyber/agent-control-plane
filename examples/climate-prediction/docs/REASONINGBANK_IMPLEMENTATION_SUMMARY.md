...
npx gendev@alpha hooks session-restore \
...
npx gendev@alpha hooks session-end \
  --export-metrics true
```
...
npx gendev@alpha memory query "model accuracy" \
  --namespace climate_prediction --reasoningbank

# Export patterns
npx gendev@alpha memory export climate_patterns.json
```
...
- [ReasoningBank Architecture](/workspaces/agent-control-plane/agent-control-plane/docs/REASONINGBANK_ARCHITECTURE.md)
- [Integration Guide](docs/REASONINGBANK_INTEGRATION.md)
- [Self-Learning Guide](/workspaces/agent-control-plane/examples/SELF_LEARNING_GUIDE.md)
- [Claude-Flow Documentation](https://github.com/tafyai/gendev)
