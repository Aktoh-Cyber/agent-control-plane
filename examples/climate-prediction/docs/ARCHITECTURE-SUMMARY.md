...
- `/workspaces/agent-control-plane/examples/climate-prediction/docs/ARCHITECTURE.md`: Detailed architecture
- `/workspaces/agent-control-plane/examples/climate-prediction/docs/ADR-*.md`: Architecture Decision Records
- `/workspaces/agent-control-plane/examples/climate-prediction/docs/API-DESIGN.md`: REST API specification
- `/workspaces/agent-control-plane/examples/climate-prediction/docs/TRAIT-DESIGN.md`: Trait system guide
- `/workspaces/agent-control-plane/examples/climate-prediction/docs/SYSTEM-DESIGN.md`: Complete system design
