...
**Project Location**: `/workspaces/agent-control-plane/examples/climate-prediction/`
...
All documentation is located in `/workspaces/agent-control-plane/examples/climate-prediction/docs/`:
...
- `/workspaces/agent-control-plane/examples/climate-prediction/Cargo.toml` - Workspace config
- `/workspaces/agent-control-plane/examples/climate-prediction/crates/*/Cargo.toml` - Individual crate configs

### Source Files

- `/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-core/src/lib.rs` - Core module
- `/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-core/src/error.rs` - Error types
- `/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-core/src/types.rs` - Domain types
- `/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-core/src/traits.rs` - Trait abstractions
- `/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-physics/Cargo.toml` - Physics crate
- `/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-cli/Cargo.toml` - CLI crate

### Documentation

- `/workspaces/agent-control-plane/examples/climate-prediction/README.md` - Project overview
...
```bash
# Session management
npx gendev@alpha hooks session-restore --session-id "climate-swarm"
...
# Complete task
npx gendev@alpha hooks post-task --task-id "climate-architecture-design"
...
**Created**: 2025-10-14
**Project Path**: `/workspaces/agent-control-plane/examples/climate-prediction/`
