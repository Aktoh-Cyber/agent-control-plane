...
**Location**: `/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-models/`
...
```
/workspaces/agent-control-plane/examples/climate-prediction/crates/climate-models/
```
