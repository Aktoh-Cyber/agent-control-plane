  ...
  res.on('end', () => {
    ...
    try {
      ...
      if (response.usage) {
        ...
        const claudeInputCost = (inputTokens / 1000000) * 3.0;
        const claudeOutputCost = (outputTokens / 1000000) * 15.0;
      ...
      console.log('   1. Use with agent-control-plane agents: --model "deepseek/deepseek-chat"');
