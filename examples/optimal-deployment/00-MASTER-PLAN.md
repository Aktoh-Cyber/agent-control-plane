...
goal_state = {
  ...
  mcp_tools: 218,
  cost_per_1m_tokens_input: 0.1 - 0.3,
  cost_per_1m_tokens_output: 0.15 - 0.4,
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/01-model-selection.md`
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/02-cost-analysis.md`
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/benchmarks/cost-calculator.ts`
...
function selectOptimalModel(
  ...
  config: 'budget' | 'balanced' | 'premium'
): string {
  const routingTable = {
    budget: {
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/03-deployment-patterns.md`
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/configs/budget-config.json`
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/configs/balanced-config.json`
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/configs/premium-config.json`
...
class OptimalMultiAgentDeployment {
  ...
  async deploySwarm(agents: AgentSpec[]): Promise<SwarmDeployment> {
    const deployedAgents = await Promise.all(agents.map((spec) => this.deployAgent(spec)));
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/05-implementation.ts`
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/04-validation-rubric.md`
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/benchmarks/performance-tests.ts`
...
- `/workspaces/agent-control-plane/agent-control-plane/examples/optimal-deployment/README.md`
...
const openrouterConfig = {
  ...
  defaultHeaders: {
    'HTTP-Referer': 'https://github.com/Aktoh-Cyber/agent-control-plane',
