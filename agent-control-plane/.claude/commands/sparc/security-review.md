...
npx gendev sparc run security-review "audit API security"

# For alpha features
npx gendev@alpha sparc run security-review "audit API security"

# With namespace
npx gendev sparc run security-review "your task" --namespace security-review

# Non-interactive mode
npx gendev sparc run security-review "your task" --non-interactive
```
...
./gendev sparc run security-review "audit API security"
```
...
```bash
# Store mode-specific context
npx gendev memory store "security-review_context" "important decisions" --namespace security-review

# Query previous work
npx gendev memory query "security-review" --limit 5
```
