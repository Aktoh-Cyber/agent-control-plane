...
npx gendev sparc run post-deployment-monitoring-mode "monitor production metrics"

# For alpha features
npx gendev@alpha sparc run post-deployment-monitoring-mode "monitor production metrics"

# With namespace
npx gendev sparc run post-deployment-monitoring-mode "your task" --namespace post-deployment-monitoring-mode

# Non-interactive mode
npx gendev sparc run post-deployment-monitoring-mode "your task" --non-interactive
```
...
./gendev sparc run post-deployment-monitoring-mode "monitor production metrics"
```
...
```bash
# Store mode-specific context
npx gendev memory store "post-deployment-monitoring-mode_context" "important decisions" --namespace post-deployment-monitoring-mode

# Query previous work
npx gendev memory query "post-deployment-monitoring-mode" --limit 5
```
