...
npx gendev sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx gendev@alpha sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx gendev sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx gendev sparc run spec-pseudocode "your task" --non-interactive
```
...
./gendev sparc run spec-pseudocode "define payment flow requirements"
```
...
```bash
# Store mode-specific context
npx gendev memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx gendev memory query "spec-pseudocode" --limit 5
```
