...
npx gendev sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx gendev@alpha sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx gendev sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx gendev sparc run refinement-optimization-mode "your task" --non-interactive
```
...
./gendev sparc run refinement-optimization-mode "optimize database queries"
```
...
```bash
# Store mode-specific context
npx gendev memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx gendev memory query "refinement-optimization-mode" --limit 5
```
