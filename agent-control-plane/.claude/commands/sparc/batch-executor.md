...
npx gendev sparc run batch-executor "process multiple files"

# For alpha features
npx gendev@alpha sparc run batch-executor "process multiple files"
```
...
./gendev sparc run batch-executor "process multiple files"
```
