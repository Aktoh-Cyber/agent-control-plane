...
npx gendev sparc run supabase-admin "create user authentication schema"

# For alpha features
npx gendev@alpha sparc run supabase-admin "create user authentication schema"

# With namespace
npx gendev sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx gendev sparc run supabase-admin "your task" --non-interactive
```
...
./gendev sparc run supabase-admin "create user authentication schema"
```
...
```bash
# Store mode-specific context
npx gendev memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx gendev memory query "supabase-admin" --limit 5
```
