...
npx gendev sparc run code "implement REST API endpoints"

# For alpha features
npx gendev@alpha sparc run code "implement REST API endpoints"

# With namespace
npx gendev sparc run code "your task" --namespace code

# Non-interactive mode
npx gendev sparc run code "your task" --non-interactive
```
...
./gendev sparc run code "implement REST API endpoints"
```
...
```bash
# Store mode-specific context
npx gendev memory store "code_context" "important decisions" --namespace code

# Query previous work
npx gendev memory query "code" --limit 5
```
