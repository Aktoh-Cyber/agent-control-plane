...
npx gendev sparc run analyzer "analyze codebase performance"

# For alpha features
npx gendev@alpha sparc run analyzer "analyze codebase performance"
```
...
./gendev sparc run analyzer "analyze codebase performance"
```
