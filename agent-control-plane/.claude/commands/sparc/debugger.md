...
npx gendev sparc run debugger "fix authentication issues"

# For alpha features
npx gendev@alpha sparc run debugger "fix authentication issues"
```
...
./gendev sparc run debugger "fix authentication issues"
```
