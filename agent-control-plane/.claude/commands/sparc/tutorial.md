...
npx gendev sparc run tutorial "guide me through SPARC methodology"

# For alpha features
npx gendev@alpha sparc run tutorial "guide me through SPARC methodology"

# With namespace
npx gendev sparc run tutorial "your task" --namespace tutorial

# Non-interactive mode
npx gendev sparc run tutorial "your task" --non-interactive
```
...
./gendev sparc run tutorial "guide me through SPARC methodology"
```
...
```bash
# Store mode-specific context
npx gendev memory store "tutorial_context" "important decisions" --namespace tutorial

# Query previous work
npx gendev memory query "tutorial" --limit 5
```
