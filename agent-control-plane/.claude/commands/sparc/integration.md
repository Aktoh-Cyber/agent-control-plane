...
npx gendev sparc run integration "connect payment service"

# For alpha features
npx gendev@alpha sparc run integration "connect payment service"

# With namespace
npx gendev sparc run integration "your task" --namespace integration

# Non-interactive mode
npx gendev sparc run integration "your task" --non-interactive
```
...
./gendev sparc run integration "connect payment service"
```
...
```bash
# Store mode-specific context
npx gendev memory store "integration_context" "important decisions" --namespace integration

# Query previous work
npx gendev memory query "integration" --limit 5
```
