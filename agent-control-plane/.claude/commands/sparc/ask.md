...
npx gendev sparc run ask "help me choose the right mode"

# For alpha features
npx gendev@alpha sparc run ask "help me choose the right mode"

# With namespace
npx gendev sparc run ask "your task" --namespace ask

# Non-interactive mode
npx gendev sparc run ask "your task" --non-interactive
```
...
./gendev sparc run ask "help me choose the right mode"
```
...
```bash
# Store mode-specific context
npx gendev memory store "ask_context" "important decisions" --namespace ask

# Query previous work
npx gendev memory query "ask" --limit 5
```
