...
npx gendev sparc run docs-writer "create API documentation"

# For alpha features
npx gendev@alpha sparc run docs-writer "create API documentation"

# With namespace
npx gendev sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
npx gendev sparc run docs-writer "your task" --non-interactive
```
...
./gendev sparc run docs-writer "create API documentation"
```
...
```bash
# Store mode-specific context
npx gendev memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
npx gendev memory query "docs-writer" --limit 5
```
