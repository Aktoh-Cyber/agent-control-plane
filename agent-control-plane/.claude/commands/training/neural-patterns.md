...
```
Tool: mcp__gendev__neural_train
Parameters: {
...
```
Tool: mcp__gendev__neural_status
Result: {
  "patterns": {
    "convergent": 0.92,
    "divergent": 0.87,
...
```
Tool: mcp__gendev__neural_patterns
Parameters: {
  "action": "analyze",
...
npx gendev neural train --type coordination --epochs 50

# Check neural status
npx gendev neural status

# Analyze patterns
npx gendev neural patterns --analyze
```
