...
gendev verify check --file src/critical.js --threshold 0.99

# Verify and auto-fix issues
gendev verify check --directory src/ --auto-fix

# Get JSON output for CI/CD
gendev verify check --json > verification.json
```
