...
```bash
gendev pair --switch <session-id>
```

### Merge Sessions

```bash
gendev pair --merge <session-1> <session-2>
```
...
```bash
gendev pair --recover [--point <timestamp>]
```

### Crash Recovery

```bash
gendev pair --crash-recovery
```
...
```bash
gendev pair --export-review <session-id>
```

### Create Learning Material

```bash
gendev pair --create-tutorial <session-id>
```
