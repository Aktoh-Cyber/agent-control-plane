...
gendev pair --start --agent senior-dev

# Start with verification
gendev pair --start --verify --threshold 0.98
```
...
```bash
gendev pair --start --mode switch --interval 10m
```
...
gendev pair --end --save

# End and generate report
gendev pair --end --report
```
...
gendev pair --start --git --review-commit
```
...
```bash
# Jest integration
gendev pair --start --test-framework jest

# Pytest integration
gendev pair --start --test-framework pytest
```
...
Configure pair programming in `.gendev/config.json`:
