...
npx gendev health-check --components ["swarm", "agents", "coordination"]

# Collect specific metrics
npx gendev metrics-collect --components ["cpu", "memory", "network"]

# Monitor SLA compliance
npx gendev sla-monitor --service swarm-coordination --threshold 99.9
```
...
npx gendev alert-config --metric cpu_usage --threshold 80 --severity warning

# Set up anomaly detection
npx gendev anomaly-setup --models ["statistical", "ml", "time_series"]

# Configure notification channels
npx gendev notification-config --channels ["slack", "email", "webhook"]
```
