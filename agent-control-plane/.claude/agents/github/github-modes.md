...
tools: mcp__gendev__swarm_init, mcp__gendev__agent_spawn, mcp__gendev__task_orchestrate, Bash, TodoWrite, Read, Write
color: purple
type: development
capabilities:
...
mcp__gendev__task_orchestrate { task: "GitHub workflow", strategy: "parallel" }
```
