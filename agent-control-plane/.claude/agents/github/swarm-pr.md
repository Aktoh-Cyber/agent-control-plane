...
mcp__gendev__agent_spawn { type: "tester", name: "Test Engineer" }
mcp__gendev__agent_spawn { type: "analyst", name: "Impact Analyzer" }
...
mcp__gendev__coordination_sync { swarmId: "pr-review-swarm" }
