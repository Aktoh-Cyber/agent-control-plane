...
mcp__gendev__agent_spawn { type: "reviewer", name: "Code Quality Reviewer" }
mcp__gendev__agent_spawn { type: "tester", name: "Testing Agent" }
mcp__gendev__agent_spawn { type: "coordinator", name: "PR Coordinator" }
...
[Single Message - Complete PR Management]:
  ...
  mcp__gendev__agent_spawn { type: "coordinator", name: "Merge Coordinator" }
