...
tools: mcp__gendev__swarm_init, mcp__gendev__agent_spawn, mcp__gendev__task_orchestrate, mcp__gendev__memory_usage, Bash, TodoWrite, Read, Write
color: green
type: development
capabilities:
...
mcp__gendev__swarm_init { topology: "star", maxAgents: 3 }
mcp__gendev__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__gendev__agent_spawn { type: "researcher", name: "Requirements Analyst" }
mcp__gendev__agent_spawn { type: "coder", name: "Implementation Planner" }
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__gendev__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__gendev__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__gendev__agent_spawn { type: "researcher", name: "Context Gatherer" }
