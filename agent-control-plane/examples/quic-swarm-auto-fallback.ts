...
import { checkQuicAvailability, initSwarm } from '../src/swarm/index.js';
...
async function main() {
  ...
  for (let iteration = 1; iteration <= 5; iteration++) {
    ...
    logger.info(`Iteration ${iteration} stats:`, {
      ...
      transportStats: {
        quic: stats.transportStats instanceof Map ? stats.transportStats.get('quic') : undefined,
        http2: stats.transportStats instanceof Map ? stats.transportStats.get('http2') : undefined,
      },
    });
