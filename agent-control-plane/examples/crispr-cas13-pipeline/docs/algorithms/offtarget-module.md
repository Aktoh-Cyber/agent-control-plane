...
1. Haeussler, M., et al. (2016). Evaluation of off-target and on-target scoring algorithms. _Genome Biology_.
2. Friedman, J. H. (2001). Greedy function approximation: A gradient boosting machine. _Annals of Statistics_.
3. Doench, J. G., et al. (2016). Optimized sgRNA design to maximize activity and minimize off-target effects. _Nature Biotechnology_.
