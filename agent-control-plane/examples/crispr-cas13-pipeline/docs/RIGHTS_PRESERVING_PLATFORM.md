...
All modules coordinated via GenDev hooks:
...
# Notifications
npx gendev@alpha hooks notify --message <message>

# Post-task completion
npx gendev@alpha hooks post-task --task-id <id>
```
...
- GenDev - Distributed orchestration
