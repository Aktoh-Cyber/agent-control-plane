...
```toml
[dependencies]
crispr-cas13-pipeline = { git = "https://github.com/Aktoh-Cyber/agent-control-plane", branch = "main" }
```
...
# In your Cargo.toml
[dependencies]
crispr-cas13-pipeline = { git = "https://github.com/Aktoh-Cyber/agent-control-plane" }
```
...
**Built with [SPARC](https://github.com/Aktoh-Cyber/agent-control-plane) + [rUv.io](https://ruv.io)**
