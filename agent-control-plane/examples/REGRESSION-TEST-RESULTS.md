...
1. **Interactive**: `agent-control-plane claude-code --provider openrouter`
2. **Non-Interactive**: `agent-control-plane claude-code --provider openrouter "Task description"`
