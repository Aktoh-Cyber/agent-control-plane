...
**Date:** 2025-11-01
**Version:** 1.8.14
**Container:** agent-control-plane-test
...
Comprehensive testing of agent-control-plane in Docker containerized environment demonstrates **100% functionality** without Claude Code dependency. All 67 agents, 15 MCP tools, and core features validated successfully.
...
7. **Agentic Cloud** (9): app-store, neural-network, sandbox, swarm, workflow, etc.
...
```bash
docker exec agent-control-plane-test node /app/dist/cli-proxy.js agent info goal-planner
```
...
services:
  agent-control-plane:
    ...
    container_name: agent-control-plane-test
    environment:
