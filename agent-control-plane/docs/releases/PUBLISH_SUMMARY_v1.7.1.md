...
```bash
npm publish --dry-run
# ✅ Success: 656 files, 1.6 MB, agent-control-plane@1.7.1
```
...
npm view agent-control-plane@1.7.1
...
- **Tag**: https://github.com/Aktoh-Cyber/agent-control-plane/releases/tag/v1.7.1
