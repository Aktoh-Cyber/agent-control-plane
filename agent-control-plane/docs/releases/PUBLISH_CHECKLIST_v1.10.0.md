...
# Verify publication
npm info agent-control-plane@1.10.0
```
...
# Or manually at: https://github.com/Aktoh-Cyber/agent-control-plane/releases/new
# - Tag: v1.10.0
# - Title: v1.10.0: Multi-Protocol Proxy Performance Breakthrough
...
- [ ] Test `npm install agent-control-plane@1.10.0`
- [ ] Test `npx agent-control-plane@1.10.0 --help`
