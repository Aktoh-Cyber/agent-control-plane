...
```typescript
import { HTTP2Proxy } from 'agent-control-plane/proxy/http2-proxy';
...
```typescript
import { OptimizedHTTP2Proxy } from 'agent-control-plane/proxy/http2-proxy-optimized';
...
```typescript
import { AdaptiveProxy } from 'agent-control-plane/proxy/adaptive-proxy';
