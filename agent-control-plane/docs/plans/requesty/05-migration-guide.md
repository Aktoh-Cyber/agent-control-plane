...
This guide will help you start using Requesty.ai with agent-control-plane to access 300+ AI models with significant cost savings.
...
npx agent-control-plane --agent architect \
...
npx agent-control-plane --agent coder --task "Create function"
```
...
```bash
npx agent-control-plane proxy --provider requesty --port 3000
```
...
npx agent-control-plane claude-code --provider requesty "Create a React app"
```

### Model Optimization

```bash
# Let agent-control-plane choose the best model automatically
npx agent-control-plane --agent coder \
...
PROXY_PORT=8080 npx agent-control-plane proxy --provider requesty --port 8080
```
...
```bash
# Let agent-control-plane choose the best model
...
### Q: Does Requesty work with all agent-control-plane features?
...
```bash
npx agent-control-plane proxy --provider requesty
```
...
- Agentic Flow Docs: https://github.com/Aktoh-Cyber/agent-control-plane
...
Save money, access 300+ models, and build amazing AI applications with agent-control-plane + Requesty.ai.
