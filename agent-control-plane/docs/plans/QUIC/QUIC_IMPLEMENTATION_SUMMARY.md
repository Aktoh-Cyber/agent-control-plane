...
**Location**: `/workspaces/agent-control-plane/docs/plans/quic-research.md`
**Size**: 5,147 words
...
**File**: `/workspaces/agent-control-plane/docs/guides/quic-configuration.md`
**Size**: 450+ lines
...
**File**: `/workspaces/agent-control-plane/docs/api/transport.md`
**Size**: 350+ lines
...
**Location**: `/workspaces/agent-control-plane/benchmarks/`
...
**File**: `/workspaces/agent-control-plane/docs/reviews/quic-implementation-review.md`
**Size**: 16,000+ lines
...
**Rust Crate** (`/workspaces/agent-control-plane/crates/agent-control-plane-quic/`):
...
2. Proxy integration
   - Integrate into agent-control-plane proxy
...
**Access**: `npx gendev@alpha memory query quic`
