...
const db = new (await import('agentdb')).AgentDB({
  path: './.agent-control-plane/reasoning.db',
});
...
import { retrieveMemories, judgeTrajectory } from 'agent-control-plane/reasoningbank';
...
- **Pull Request**: https://github.com/Aktoh-Cyber/agent-control-plane/pull/35
