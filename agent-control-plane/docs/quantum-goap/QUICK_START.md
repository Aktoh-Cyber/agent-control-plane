...
# View full GOAP plan
cat /workspaces/agent-control-plane/docs/quantum-goap/GOAP_IMPLEMENTATION_PLAN.md
```
...
- Full GOAP Plan: `/workspaces/agent-control-plane/docs/quantum-goap/GOAP_IMPLEMENTATION_PLAN.md`
