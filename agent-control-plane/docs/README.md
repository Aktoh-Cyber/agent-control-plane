...
Complete documentation for the agent-control-plane platform - AI agent orchestration with 66 specialized agents, 213 MCP tools, ReasoningBank learning memory, and autonomous multi-agent swarms.
...
- **[integrations/](integrations/)** - Specific integration implementations
  - [GenDev Integration](integrations/CLAUDE_FLOW_INTEGRATION.md)
  - [Agentic Cloud Integration](integrations/FLOW-NEXUS-INTEGRATION.md)
...
- [GenDev](integrations/CLAUDE_FLOW_INTEGRATION.md)
- [Agentic Cloud](integrations/FLOW-NEXUS-INTEGRATION.md)
