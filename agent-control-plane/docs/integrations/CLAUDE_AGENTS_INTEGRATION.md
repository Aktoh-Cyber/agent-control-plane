...
// Use it
const result = await claudeAgent(goalPlanner, 'Create a plan to improve our API performance');
...
```typescript
const result = await claudeAgent(goalPlanner, 'Create a 3-step plan', (chunk) =>
