...
```bash
# From the project root: /workspaces/agent-control-plane/agent-control-plane
...
pwd  # Should show: /workspaces/agent-control-plane/agent-control-plane
```
...
```typescript
// In your agent code
import { AgentDBCLI } from 'agent-control-plane/agentdb';
