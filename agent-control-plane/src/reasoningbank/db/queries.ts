...
import type { MattsRun, PatternEmbedding, ReasoningMemory, TaskTrajectory } from './schema.js';
 ...
 */
export function pruneOldMemories(options: { maxAgeDays: number; minConfidence: number }): number {
  const db = getDb();
