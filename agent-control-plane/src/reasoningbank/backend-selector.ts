 ...
 * Usage:
 * ```typescript
 * import { createOptimalReasoningBank, getRecommendedBackend } from 'agent-control-plane/reasoningbank/backend-selector';
 *
...
// Declare browser globals for environment detection
