  ...
  try {
    ...
    configCache = {
      retrieve: {
        ...
        gamma: raw.retrieve?.gamma ?? 0.2,
        delta: raw.retrieve?.delta ?? 0.1,
      ...
      distill: {
        ...
        confidence_prior_failure: raw.distill?.failure_confidence_prior ?? 0.6,
      },
      consolidate: {
    ...
    console.warn(
      `[ReasoningBank] Could not load config from ${configPath}, using defaults:`,
