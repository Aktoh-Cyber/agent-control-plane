...
export { DEFAULT_TIERS, PricingManager } from './pricing/tiers.js';
...
export class BillingSystem extends EventEmitter {
  ...
  private setupEventForwarding(): void {
    ...
    this.subscriptions.on('subscription.created', (data) =>
      this.emit('subscription.created', data)
    );
    this.subscriptions.on('subscription.upgraded', (data) =>
      this.emit('subscription.upgraded', data)
    );
    this.subscriptions.on('subscription.downgraded', (data) =>
      this.emit('subscription.downgraded', data)
    );
    this.subscriptions.on('subscription.canceled', (data) =>
      this.emit('subscription.canceled', data)
    );
    this.subscriptions.on('subscription.renewed', (data) =>
