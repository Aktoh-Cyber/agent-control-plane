  ...
  return withRetry(async () => {
    ...
    if (provider === 'gemini' && process.env.GOOGLE_GEMINI_API_KEY) {
      ...
      envOverrides.ANTHROPIC_BASE_URL =
        process.env.ANTHROPIC_BASE_URL || process.env.GEMINI_PROXY_URL || 'http://localhost:3000';
      ...
      envOverrides.ANTHROPIC_BASE_URL =
        process.env.ANTHROPIC_BASE_URL || process.env.ONNX_PROXY_URL || 'http://localhost:3001';
