#!/usr/bin/env node
/**
 * Interactive CLI wizard for agent-control-plane configuration
...
const CONFIG_DEFINITIONS: ConfigValue[] = [
  ...
  },
  {
    ...
    required: false,
    validation: (val) =>
      ['anthropic', 'openrouter', 'gemini', 'onnx'].includes(val) ||
      'Must be anthropic, openrouter, gemini, or onnx',
  },
  {
    key: 'AGENTS_DIR',
    value: '',
...
export class ConfigWizard {
  ...
  private saveConfig(): void {
    const lines: string[] = [
      ...
      '# Generated by agent-control-plane config wizard',
  ...
  async runInteractive(): Promise<void> {
    ...
    console.log('Configure your environment variables for agent-control-plane.');
  ...
  showSummary(): void {
    ...
    console.log('  npx agent-control-plane --list              # List available agents');
    console.log('  npx agent-control-plane --agent coder --task "Your task"  # Run agent');
    console.log('');
  }
