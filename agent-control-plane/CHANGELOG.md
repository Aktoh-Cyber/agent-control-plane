...
- **Critical Bug**: Fixed ANTHROPIC_API_KEY overriding `--provider` CLI argument ([#60](https://github.com/Aktoh-Cyber/agent-control-plane/issues/60))
...
npx agent-control-plane --provider openrouter --task "test"
...
# Or use CLI argument
npx agent-control-plane --provider openrouter --openrouter-key sk-or-... --task "test"
```
