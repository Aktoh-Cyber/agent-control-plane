...
async function main() {
  ...
  results.push(test1);
  console.log(
    `  ${test1.status === 'pass' ? '✅' : '❌'} ${test1.status.toUpperCase()} (${test1.duration}ms)\n`
  );
  ...
  results.push(test2);
  console.log(
    `  ${test2.status === 'pass' ? '✅' : '❌'} ${test2.status.toUpperCase()} (${test2.duration}ms)\n`
  );
  ...
  results.push(test3);
  console.log(
    `  ${test3.status === 'pass' ? '✅' : '❌'} ${test3.status.toUpperCase()} (${test3.duration}ms)\n`
  );
  ...
  results.push(test4);
  console.log(
    `  ${test4.status === 'pass' ? '✅' : '❌'} ${test4.status.toUpperCase()} (${test4.duration}ms)\n`
  );
