...
import { HybridReasoningBank, PatternData } from '../../src/reasoningbank/HybridBackend.js';
...
describe('HybridReasoningBank v1.7.1 - Full Implementation', () => {
  ...
  describe('Pattern Storage', () => {
    ...
    it('should store multiple related patterns', async () => {
      ...
      const episodeIds = await Promise.all(patterns.map((p) => reasoningBank.storePattern(p)));
