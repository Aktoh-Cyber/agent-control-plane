...
export class AuthorizationService {
  ...
  async grantAuthorization(
    authorization: Omit<Authorization, 'id' | 'auditTrail'>
    ...
    console.log(
      `[AUTHORIZATION] Granted ${authorization.accessLevel} access to provider ${authorization.providerId} for patient ${authorization.patientId}`
    );
  ...
  async updateAccessLevel(
    ...
    console.log(
      `[AUTHORIZATION] Updated access level for ${authorizationId} from ${oldLevel} to ${newAccessLevel}`
    );
