...
export const DEFAULT_CONFIG: SystemConfig = {
  antiHallucination: {
    ...
    knowledgeBaseSources: ['PubMed', 'Mayo Clinic', 'UpToDate', 'NEJM', 'The Lancet'],
  },
  providers: {
...
export class ConfigManager {
  ...
  public validate(): boolean {
    ...
    if (
      this.config.antiHallucination.minimumConfidence < 0 ||
    ...
    if (
      this.config.antiHallucination.requireProviderReviewThreshold <
