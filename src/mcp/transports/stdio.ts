...
const tools = [
  {
    ...
    description:
      'Analyze medical symptoms and conditions with anti-hallucination safeguards. Provides confidence scoring, citation verification, and emergency escalation.',
    inputSchema: {
      type: 'object',
      properties: {
        symptoms: {
  ...
  },
  {
    name: 'medical_verify',
    description:
      'Verify medical analysis quality and accuracy with comprehensive checks for confidence, citations, consistency, completeness, and safety.',
    inputSchema: {
      type: 'object',
      properties: {
        analysisId: {
  ...
  },
  {
    ...
    description:
      'Notify healthcare providers about medical analyses requiring review. Supports multiple channels (email, SMS, pager, app) based on urgency.',
    inputSchema: {
      type: 'object',
      properties: {
        analysisId: {
  ...
  },
  {
    ...
    description:
      'Calculate comprehensive confidence scores for medical analyses with component breakdown (diagnosis, treatment, prognosis) and quality metrics.',
    inputSchema: {
      type: 'object',
      properties: {
        analysis: {
  ...
  },
  {
    ...
    description:
      'Verify medical citations against trusted sources (PubMed, Cochrane, NICE, etc.). Validates citation quality, relevance, and source reliability.',
    inputSchema: {
      type: 'object',
      properties: {
        citations: {
  ...
  },
  {
    ...
    description:
      'Search medical knowledge bases (PubMed, Cochrane, UpToDate, NICE) for relevant clinical information, guidelines, and research.',
    inputSchema: {
      type: 'object',
      properties: {
        query: {
...
async function main() {
  ...
  console.error(
    '🏥 Tools: medical_analyze, medical_verify, provider_notify, confidence_score, citation_verify, knowledge_search'
  );
  console.error(
    '✨ Features: Real-time confidence monitoring, citation validation, emergency escalation'
  );
