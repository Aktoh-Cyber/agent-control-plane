...
import type { Citation, MCPToolResponse, ValidationResult } from '../types';
...
export class CitationVerifyTool {
   ...
   * Verify citations
   */
  async execute(args: { citations: Citation[]; strictMode?: boolean }): Promise<MCPToolResponse> {
    try {
   ...
   */
  private generateSummary(validation: ValidationResult, results: any[]): any {
