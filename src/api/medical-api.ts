...
import { MCPToolRequest, MCPToolResponse, MedicalAnalysis, PatientData } from '../types/medical';
...
export class MedicalAPI {
  ...
  ): Promise<{ success: boolean; data?: MedicalAnalysis; error?: string }> {
    try {
