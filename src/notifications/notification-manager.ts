...
export class NotificationManager {
  ...
  private initializeNotifiers(): void {
    ...
    if (this.config.channels.inapp) {
      this.notifiers.set(NotificationChannel.INAPP, new InAppNotifier(this.config.channels.inapp));
    }
  }
   ...
   */
  async broadcast(payloads: NotificationPayload[]): Promise<Map<string, NotificationResult[]>> {
