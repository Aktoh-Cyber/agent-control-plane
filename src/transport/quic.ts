...
import type { WasmQuicClient } from '../../crates/agent-control-plane-quic/pkg';
 ...
 * @returns Promise resolving to QuicTransport instance
 */
export async function createQuicTransport(config?: QuicTransportConfig): Promise<QuicTransport> {
