...
export class ProviderService {
  ...
  private determinePriority(
    ...
    if (analysis.confidenceScore.overall < 0.5) return 'high';
    if (analysis.confidenceScore.overall < 0.7) return 'medium';
  ...
  private async sendSMS(
    ...
    console.log(
      `   [${priority.toUpperCase()}] Analysis ${analysisId.substring(0, 8)} requires review`
    );
  }
