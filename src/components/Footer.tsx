import { Book, ExternalLink, Github, Package } from 'lucide-react';
...
const links = {
  ...
  resources: [
    { name: 'GitHub', url: 'https://github.com/Aktoh-Cyber/agent-control-plane', icon: Github },
    {
      name: 'npm Package',
      url: 'https://www.npmjs.com/package/agent-control-plane',
      icon: Package,
    },
    {
      name: 'Documentation',
      url: 'https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/docs',
      icon: Book,
    },
  ],
  components: [
    ...
    <footer className="bg-background-light border-t border-border py-16 px-6">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div>
            <h4 className="text-lg font-bold mb-6 text-foreground">Documentation</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-6 text-foreground">Components</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <div className="text-2xl font-bold text-gradient mb-2">Agentic Flow</div>
            ...
            <div className="flex items-center gap-6">
              <a
                href="https://github.com/Aktoh-Cyber/agent-control-plane"
                className="text-muted-foreground hover:text-primary transition-smooth"
              >
                <Github className="w-6 h-6" />
              </a>
              <a
                href="https://www.npmjs.com/package/agent-control-plane"
                className="text-muted-foreground hover:text-primary transition-smooth"
              >
