...
const components = [
  {
    ...
    name: 'Agent Booster',
    description:
      'Ultra-fast local code transformations via Rust/WASM with automatic edit detection',
    features: ['352x faster', '$0 cost', 'Automatic detection', 'Rust/WASM powered'],
    docs: 'https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/agent-booster',
  },
  {
    icon: Database,
    name: 'AgentDB',
    ...
    docs: './agent-control-plane/src/agentdb/README.md',
  },
  {
    icon: Network,
    name: 'ReasoningBank',
    ...
    docs: 'https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/agent-control-plane/src/reasoningbank',
  },
  {
    icon: Cpu,
    ...
    docs: 'https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/agent-control-plane/src/router',
  },
];
              ...
              >
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold mb-3 text-foreground">{component.name}</h3>
        ...
        <div className="mt-16 bg-background-light border border-border rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <code className="block bg-background rounded-lg p-4 text-sm text-primary font-mono">
                npx agent-control-plane --agent coder --optimize
              </code>
            </div>
            <div>
            ...
            <div>
              ...
              <code className="block bg-background rounded-lg p-4 text-sm text-primary font-mono">
                import * as reasoningbank from 'agent-control-plane'
              </code>
            </div>
          </div>
        </div>
