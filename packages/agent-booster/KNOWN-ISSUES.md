...
```bash
# Use agent-control-plane agent (not Agent Booster)
npx agent-control-plane --agent coder --task "convert var to const in file.js"
...
### MCP Integration (agent-control-plane@1.4.2)
...
**Version:** agent-booster@0.1.2, agent-control-plane@1.4.2
