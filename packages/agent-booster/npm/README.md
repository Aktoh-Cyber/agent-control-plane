...
// Batch processing
const results = await agentBooster.batchApply(['Prompt 1', 'Prompt 2', 'Prompt 3']);
...
import type { OptimizationOptions, AnalysisResult, VersionInfo, RuntimeType } from 'agent-booster';
...
- [GitHub Repository](https://github.com/yourusername/agent-control-plane)
- [Issue Tracker](https://github.com/yourusername/agent-control-plane/issues)
