...
export class OptimizationService {
  async optimizePrompt(prompt: string, options?: OptimizationOptions): Promise<string> {
    return agentBooster.apply(prompt, options);
  }

  async optimizeBatch(prompts: string[], options?: OptimizationOptions): Promise<string[]> {
...
- [GitHub Issues](https://github.com/yourusername/agent-control-plane/issues)
