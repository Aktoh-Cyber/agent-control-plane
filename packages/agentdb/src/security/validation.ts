...
export function validateSearchOptions(options: SearchOptions): SearchOptions {
  ...
  if (options.threshold !== undefined) {
    ...
    if (
      options.threshold < SECURITY_LIMITS.MIN_THRESHOLD ||
  ...
  if (options.efSearch !== undefined) {
    ...
    if (
      options.efSearch < SECURITY_LIMITS.MIN_EF_SEARCH ||
...
export function validateHNSWParams(params: HNSWParams): HNSWParams {
  ...
  if (params.efConstruction !== undefined) {
    ...
    if (
      params.efConstruction < SECURITY_LIMITS.MIN_EF_CONSTRUCTION ||
 ...
 */
export function validateCypherParams(params: Record<string, any>): Record<string, any> {
