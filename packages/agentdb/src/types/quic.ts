 ...
 */
export function isEpisodeSync(
  payload: SyncPayload
): payload is { type: 'episode_sync'; data: EpisodeSync } {
 ...
 */
export function isSkillSync(
  payload: SyncPayload
): payload is { type: 'skill_sync'; data: SkillSync } {
 ...
 */
export function isCausalEdgeSync(
  payload: SyncPayload
): payload is { type: 'causal_edge_sync'; data: CausalEdgeSync } {
