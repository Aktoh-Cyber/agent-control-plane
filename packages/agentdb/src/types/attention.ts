 ...
 */
export function isCausalEdgeWithAttention(edge: any): edge is CausalEdgeWithAttention {
  return (
    typeof edge === 'object' &&
    edge !== null &&
 ...
 */
export function isPatternWithAttention(pattern: any): pattern is ReasoningPatternWithAttention {
  return (
