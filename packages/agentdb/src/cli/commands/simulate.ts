...
export const simulateCommand = new Command('simulate')
  ...
  .argument(
    '[scenario]',
    'Simulation scenario to run (hnsw, attention, clustering, traversal, hypergraph, self-organizing, neural, quantum)'
  )
  ...
  .action(async (scenario, options) => {
    try {
      ...
      console.log(
        chalk.cyan.bold('║  AgentDB Latent Space Simulation                           ║')
      );
      console.log(
        chalk.cyan.bold('╚══════════════════════════════════════════════════════════════╝\n')
      );
