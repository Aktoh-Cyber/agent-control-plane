...
export class AttentionBrowser {
   ...
   */
  async hyperbolicAttention(query: Float32Array, keys: Float32Array): Promise<Float32Array> {
    await this.initialize();
  ...
  private hyperbolicAttentionFallback(query: Float32Array, keys: Float32Array): Float32Array {
