...
- **Location**: `/workspaces/agent-control-plane/packages/agentdb/src/backends/VectorBackend.ts`
...
- **Location**: `/workspaces/agent-control-plane/packages/agentdb/src/backends/ruvector/RuVectorBackend.ts`
...
- **Location**: `/workspaces/agent-control-plane/packages/agentdb/src/backends/ruvector/RuVectorLearning.ts`
...
- **Location**: `/workspaces/agent-control-plane/packages/agentdb/src/backends/hnswlib/HNSWLibBackend.ts`
...
- **Location**: `/workspaces/agent-control-plane/packages/agentdb/src/backends/factory.ts`
