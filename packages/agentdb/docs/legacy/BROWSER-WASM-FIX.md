...
Failed to load url ../../../agent-control-plane/wasm/reasoningbank/reasoningbank_wasm.js
```
...
### 1. `/workspaces/agent-control-plane/packages/agentdb/tests/browser-bundle.test.js`
...
### 2. `/workspaces/agent-control-plane/packages/agentdb/src/browser-entry.js`
...
### 3. `/workspaces/agent-control-plane/packages/agentdb/src/controllers/WASMVectorSearch.ts`
