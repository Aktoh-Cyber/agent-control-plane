  ...
  "recommendations": [
    {
      ...
      "causal_chain": [{ "cause": "jwt_expired", "effect": "auth_failed", "confidence": 0.95 }]
    }
  ]
}
```
...
- **[Verification Report](/workspaces/agent-control-plane/docs/agentdb-tools-verification.md)** - Complete tool verification
