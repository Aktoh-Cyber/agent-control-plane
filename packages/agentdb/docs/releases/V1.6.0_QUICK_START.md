...
// Complete workflow
async function intelligentSearch(query: string, memories: any[]): Promise<SynthesizedContext> {
  ...
  const diverse = MMRDiversityRanker.selectDiverse(filtered, queryEmbedding, {
    k: 10,
    lambda: 0.5,
  });
