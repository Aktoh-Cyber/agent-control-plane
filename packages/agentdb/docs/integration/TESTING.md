...
1. Check existing issues: https://github.com/Aktoh-Cyber/agent-control-plane/issues
2. Review test output and error messages
3. Run tests in debug mode: `npx vitest --debug`
4. Ask in discussions: https://github.com/Aktoh-Cyber/agent-control-plane/discussions
