...
1. `/workspaces/agent-control-plane/packages/agentdb/src/mcp/attention-tools-handlers.ts` - Tool handlers and definitions
2. `/workspaces/agent-control-plane/packages/agentdb/src/mcp/attention-mcp-integration.ts` - Integration helper

## Integration Steps

### 1. Import Attention Tools

Add to `/workspaces/agent-control-plane/packages/agentdb/src/mcp/agentdb-mcp-server.ts` imports section:
