...
// Add experts
await attention.moe.addExpert('Technical Expert', 'technical_documentation', technicalVectors);

await attention.moe.addExpert('Business Expert', 'business_analysis', businessVectors);
...
await attention.moe.addExpert('JavaScript Expert', 'javascript_programming', jsMemories);
...
for (const domain of domains) {
  ...
  await attention.moe.addExpert(`${domain.name} Expert`, domain.name.toLowerCase(), vectors);
}
