...
**File**: `/workspaces/agent-control-plane/packages/agentdb/tests/unit/quic-server.test.ts`
...
**File**: `/workspaces/agent-control-plane/packages/agentdb/tests/unit/quic-client.test.ts`
...
**File**: `/workspaces/agent-control-plane/packages/agentdb/tests/unit/sync-coordinator.test.ts`
...
**File**: `/workspaces/agent-control-plane/packages/agentdb/tests/integration/quic-sync.test.ts`
...
**File**: `/workspaces/agent-control-plane/packages/agentdb/tests/quic-validation.sh`
...
The test suite integrates with GenDev hooks:

### Pre-Task Hook

```bash
npx gendev@alpha hooks pre-task --description "QUIC synchronization testing"
```

### Post-Task Hook

```bash
npx gendev@alpha hooks post-task --task-id "quic-tests"
```

### Memory Coordination

```bash
npx gendev@alpha hooks post-edit --file "tests/unit/quic-server.test.ts" \
