  ...
  async run(config: any) {
    ...
    results.consciousnessLevel =
      (0.75 * results.perceptualLayer +
        ...
        0.9 * results.metacognitiveLayer) /
    ...
    if (verbosity >= 2) {
      ...
      console.log(
        `      📊 Integrated Information (φ): ${results.integratedInformation.toFixed(2)}`
      );
      console.log(
        `      📊 Consciousness Level: ${(results.consciousnessLevel * 100).toFixed(1)}%`
      );
