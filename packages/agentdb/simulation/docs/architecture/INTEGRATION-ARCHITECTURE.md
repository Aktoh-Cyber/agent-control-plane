...
See `/workspaces/agent-control-plane/packages/agentdb/simulation/docs/architecture/EXTENSION-API.md` for full details.
...
See `/workspaces/agent-control-plane/packages/agentdb/simulation/docs/guides/MIGRATION-GUIDE.md` for details.
...
- **Simulation Discoveries**: `/workspaces/agent-control-plane/packages/agentdb/simulation/docs/SIMULATION-FINDINGS.md`
- **CLI Integration Plan**: `/workspaces/agent-control-plane/packages/agentdb/simulation/docs/CLI-INTEGRATION-PLAN.md`
- **Extension API**: `/workspaces/agent-control-plane/packages/agentdb/simulation/docs/architecture/EXTENSION-API.md`
- **Deployment Guide**: `/workspaces/agent-control-plane/packages/agentdb/simulation/docs/guides/DEPLOYMENT.md`
- **Migration Guide**: `/workspaces/agent-control-plane/packages/agentdb/simulation/docs/guides/MIGRATION-GUIDE.md`
