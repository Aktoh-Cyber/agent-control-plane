...
describe('MCP Tool Integration', () => {
  it('should validate agentdb_pattern_store schema', async () => {
    const { storePattern } = await import('../src/mcp/agentdb-mcp-server.js').catch(() => ({
      storePattern: null,
    }));
  ...
  it('should validate agentdb_pattern_search schema', async () => {
    const { searchPattern } = await import('../src/mcp/agentdb-mcp-server.js').catch(() => ({
      searchPattern: null,
    }));
  ...
  it('should validate agentdb_stats schema', async () => {
    const { getStats } = await import('../src/mcp/agentdb-mcp-server.js').catch(() => ({
      getStats: null,
    }));
