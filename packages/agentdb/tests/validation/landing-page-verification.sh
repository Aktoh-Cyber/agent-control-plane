...
test_feature "API: MMRDiversityRanker exports" \
    "node -e \"require('/workspaces/agent-control-plane/packages/agentdb/dist/controllers/MMRDiversityRanker.js')\""

test_feature "API: ContextSynthesizer exports" \
    "node -e \"require('/workspaces/agent-control-plane/packages/agentdb/dist/controllers/ContextSynthesizer.js')\""

test_feature "API: MetadataFilter exports" \
    "node -e \"require('/workspaces/agent-control-plane/packages/agentdb/dist/controllers/MetadataFilter.js')\""

test_feature "API: All controllers from index" \
    "node -e \"const m = require('/workspaces/agent-control-plane/packages/agentdb/dist/controllers/index.js'); if (!m.MMRDiversityRanker || !m.ContextSynthesizer || !m.MetadataFilter) process.exit(1)\""
