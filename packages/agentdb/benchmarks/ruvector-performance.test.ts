...
describe('RuVector Core (@ruvector/core) Performance', () => {
  it('should benchmark vector insert performance', async () => {
    ...
    // Single insert
    const singleInsert = await benchmark(
    ...
    const batchInsert = await benchmark(
  ...
  it('should benchmark vector search performance', async () => {
    ...
    // Search k=10
    const search10 = await benchmark(
      'Vector Search (k=10)',
      async () => {
    ...
    // Search k=100
    const search100 = await benchmark(
      'Vector Search (k=100)',
      async () => {
...
describe('RuVector Graph Database (@ruvector/graph-node) Performance', () => {
  it('should benchmark node creation performance', async () => {
    ...
    const singleNode = await benchmark(
    ...
    const batchCreate = await benchmark(
  ...
  it('should benchmark Cypher query performance', async () => {
    ...
    // Simple query
    const simpleQuery = await benchmark(
    ...
    const complexQuery = await benchmark(
  ...
  it('should benchmark graph traversal performance', async () => {
    ...
    const traversal = await benchmark(
...
describe('RuVector GNN (@ruvector/gnn) Performance', () => {
  it('should benchmark GNN forward pass performance', async () => {
    ...
    const forwardPass = await benchmark(
      'GNN Forward Pass (3 neighbors)',
      async () => {
  ...
  it('should benchmark tensor compression performance', async () => {
    ...
    const compression = await benchmark(
      'Tensor Compression',
      async () => {
    ...
    const decompression = await benchmark(
  ...
  it('should benchmark differentiable search performance', async () => {
    ...
    const search = await benchmark(
      'Differentiable Search (100 candidates)',
      async () => {
...
describe('AgentDB SDK Integration Performance', () => {
  it('should benchmark ReflexionMemory with GraphDatabase', async () => {
    ...
    const storeEpisode = await benchmark(
    ...
    const retrieveEpisode = await benchmark(
  ...
  it('should benchmark SkillLibrary with GraphDatabase', async () => {
    ...
    const db = await createUnifiedDatabase(path.join(BENCH_DIR, 'bench-skills.graph'), embedder, {
      forceMode: 'graph',
    });
    ...
    const createSkill = await benchmark(
    ...
    const searchSkill = await benchmark(
      'SkillLibrary Search Skills',
      async () => {
