...
console.log(
  `📊 Learning stats: ${stats.total_trajectories} trajectories, avg success: ${(stats.avg_success_rate * 100).toFixed(1)}%`
);
...
wrapper3.finalizeTrajectory(0.9, 'Migration completed successfully');
...
// Encrypt
const encrypted = encryptTrajectory(JSON.stringify(trajectoryData), keyPair4.publicKey);
