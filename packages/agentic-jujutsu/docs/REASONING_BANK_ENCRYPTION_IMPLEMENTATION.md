...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/reasoning_bank.rs`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/wrapper.rs`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/index.d.ts`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/helpers/encryption.js`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/tests/encryption.test.js`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/docs/ENCRYPTION_GUIDE.md`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/examples/encrypted-reasoning-bank.js`
