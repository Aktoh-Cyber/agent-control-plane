# NPM Publication Guide - @agent-control-plane/jujutsu
...
**Name:** `@agent-control-plane/jujutsu`
**Scope:** @agent-control-plane (organization package)
**Version:** 0.1.0
**License:** MIT
...
```json
{
  ...
  "files": ["pkg/", "typescript/", "README.md", "LICENSE"]
}
```
...
1. **NPM Account**
   ...
   - Join @agent-control-plane organization (if applicable)
...
3. **Organization Access**
   - Request access to @agent-control-plane org
...
```bash
# Load token
export NPM_TOKEN=$(grep NPM_TOKEN /workspaces/agent-control-plane/.env | cut -d '=' -f2)
...
```bash
# Search for package
npm search @agent-control-plane/jujutsu

# Install to test
npm install @agent-control-plane/jujutsu

# Check on npm
# Visit: https://www.npmjs.com/package/@agent-control-plane/jujutsu
```
...
# Test import (Node.js)
node -e "const jj = require('@agent-control-plane/jujutsu'); console.log('✅ Import successful');"

# Test import (ES modules)
node --input-type=module -e "import * as jj from '@agent-control-plane/jujutsu'; console.log('✅ ESM import successful');"
```
...
```javascript
// Node.js (CommonJS)
const { JJWrapper } = require('@agent-control-plane/jujutsu');
...
```javascript
// Browser (via bundler)
import { JJWrapper } from '@agent-control-plane/jujutsu/web';
...
```typescript
// TypeScript
import { JJWrapper, JJConfig } from '@agent-control-plane/jujutsu';
...
```
🚀 @agent-control-plane/jujutsu v0.1.0 released!
...
npm org ls @agent-control-plane
...
- **npm:** https://www.npmjs.com/package/@agent-control-plane/jujutsu
- **unpkg CDN:** https://unpkg.com/@agent-control-plane/jujutsu
- **jsDelivr CDN:** https://cdn.jsdelivr.net/npm/@agent-control-plane/jujutsu
- **crates.io:** https://crates.io/crates/agentic-jujutsu
- **GitHub:** https://github.com/Aktoh-Cyber/agent-control-plane
