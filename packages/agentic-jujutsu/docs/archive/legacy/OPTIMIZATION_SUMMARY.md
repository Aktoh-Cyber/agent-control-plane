...
- [OPTIMIZATION_REPORT.md](/workspaces/agent-control-plane/packages/agentic-jujutsu/docs/OPTIMIZATION_REPORT.md) - Detailed analysis
- [OPTIMIZATION_GUIDE.md](/workspaces/agent-control-plane/packages/agentic-jujutsu/docs/OPTIMIZATION_GUIDE.md) - Implementation guide
