...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/hooks.rs:163-166`
...
**Severity:** 🔴 Critical
**Impact:** Compilation failure
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/wrapper.rs:261`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/config.rs:11,14`
...
- `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/lib.rs:16`
- `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/wrapper.rs:12`
- `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/hooks.rs:7`
...
- `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/agentdb_sync.rs` (3 instances)
- `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/hooks.rs` (1 instance)
- `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/bin/jj-agent-hook.rs` (2 instances)
...
**Severity:** 🟡 Medium
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/types.rs:813`
...
**Severity:** 🟡 Medium
**Impact:** Performance
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/types.rs`
...
**Severity:** 🟡 Medium
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/hooks.rs:250`
...
**Severity:** 🟡 Medium
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/Cargo.toml:76-77`
...
**File:** `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/operations.rs`
...
**Recommendation:**
Create `/workspaces/agent-control-plane/packages/agentic-jujutsu/tests/integration/hooks_agentdb.rs`
