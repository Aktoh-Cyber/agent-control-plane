...
This document analyzes multi-agent coordination patterns for agentic-jujutsu, integrating Jujutsu VCS's unique capabilities with agent-control-plane's 352x faster code editing, AgentDB's 150x faster vector search, and GenDev's 213 MCP coordination tools.
...
### 6.3 GenDev MCP Tools (213 Tools)
