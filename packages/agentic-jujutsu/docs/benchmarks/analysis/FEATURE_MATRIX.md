...
1. **Multi-agent systems** (agent-control-plane's primary use case)
...
**For agent-control-plane:** Jujutsu is the **recommended choice**, with Git interoperability ensuring smooth integration with existing workflows.
