...
1. `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/quantum_bridge.js`
   - QuantumBridge class
   - DAG vertex management
   - Conflict detection algorithm
   - Quantum verification

2. `/workspaces/agent-control-plane/packages/agentic-jujutsu/quantum-bridge.d.ts`
...
3. `/workspaces/agent-control-plane/packages/agentic-jujutsu/docs/QUANTUM_DAG_INTEGRATION.md`
...
4. `/workspaces/agent-control-plane/packages/agentic-jujutsu/docs/examples/QUANTUM_COORDINATION_USAGE.md`
   - 8 usage examples
   - Best practices
   - Error handling
   - CI/CD integration

5. `/workspaces/agent-control-plane/packages/agentic-jujutsu/README_QUANTUM_INTEGRATION.md`
...
6. `/workspaces/agent-control-plane/packages/agentic-jujutsu/tests/integration/quantum-bridge.test.js`
   - 9 integration tests
   - Mock coordination setup
   - Conflict detection tests
   - Quantum verification tests

7. `/workspaces/agent-control-plane/packages/agentic-jujutsu/tests/unit/quantum-bridge-unit.test.js`
...
8. `/workspaces/agent-control-plane/packages/agentic-jujutsu/examples/quantum-coordination-example.js`
...
1. `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/agent_coordination.rs`
...
2. `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/operations.rs`
   - Fixed builder to include signature fields

3. `/workspaces/agent-control-plane/packages/agentic-jujutsu/src/wrapper.rs`
   - Fixed JSON serialization error

#### Package Configuration

4. `/workspaces/agent-control-plane/packages/agentic-jujutsu/package.json`
...
All files are in `/workspaces/agent-control-plane/packages/agentic-jujutsu/`:
