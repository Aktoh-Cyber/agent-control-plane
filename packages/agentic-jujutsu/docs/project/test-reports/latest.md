...
**Status**: ✅ Created
**Location**: `/workspaces/agent-control-plane/packages/agentic-jujutsu/tests/napi-basic.test.js`
...
**Status**: ✅ Created
**Location**: `/workspaces/agent-control-plane/packages/agentic-jujutsu/Dockerfile`
