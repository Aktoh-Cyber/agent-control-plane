...
Successfully created seamless integration between agentic-jujutsu and agent-control-plane hooks system.
...
The hooks integrate seamlessly with agent-control-plane commands:
