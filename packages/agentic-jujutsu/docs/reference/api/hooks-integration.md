...
Complete guide for integrating agentic-jujutsu with the agent-control-plane hooks system.

## Overview

The hooks integration enables automatic tracking of all jj operations within agent-control-plane workflows, providing:
