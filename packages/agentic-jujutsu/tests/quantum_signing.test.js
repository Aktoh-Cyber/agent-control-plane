...
describe('QuantumSigner', () => {
  ...
  describe('Signature Verification', () => {
    ...
    test('should reject invalid commit ID', () => {
      const isValid = QuantumSigner.verifyCommit('wrong-commit-id', signature, keypair.publicKey);
    ...
    test('should verify signature with metadata', () => {
      ...
      const sigWithMeta = QuantumSigner.signCommit(commitId, keypair.secretKey, metadata);

      const isValid = QuantumSigner.verifyCommit(commitId, sigWithMeta, keypair.publicKey);
    ...
    test('should reject wrong algorithm', () => {
      ...
      const isValid = QuantumSigner.verifyCommit(commitId, tamperedSig, keypair.publicKey);
    ...
    test('should handle different keypairs', () => {
      ...
      const isValid = QuantumSigner.verifyCommit(commitId, signature, keypair2.publicKey);
  ...
  describe('Edge Cases', () => {
    test('should handle very long commit IDs', () => {
      ...
      const isValid = QuantumSigner.verifyCommit(longCommitId, signature, keypair.publicKey);
      expect(isValid).toBe(true);
    });
    ...
    test('should handle special characters in metadata', () => {
      ...
      const signature = QuantumSigner.signCommit('special-chars-test', keypair.secretKey, metadata);
