/**
 * TypeScript integration for agent-control-plane hooks system
 *
 * This module provides type-safe integration between agentic-jujutsu
 * and the agent-control-plane hooks system for Node.js and browser environments.
 */

import { JJConfig, JJOperation, JJWrapper } from './index';
...
/**
 * Integration layer for agent-control-plane hooks
 */
