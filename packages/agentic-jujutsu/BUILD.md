...
1. Go to: https://github.com/Aktoh-Cyber/agent-control-plane/actions
...
2. Add as repository secret at https://github.com/Aktoh-Cyber/agent-control-plane/settings/secrets/actions
   - Name: `NPM_TOKEN`
