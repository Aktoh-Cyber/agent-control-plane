//! Main integration module for agent-control-plane components
//!
//! Coordinates all agent-control-plane features:
...
/// Main integration struct coordinating all agent-control-plane features
