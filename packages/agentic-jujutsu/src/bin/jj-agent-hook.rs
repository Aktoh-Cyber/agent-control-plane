...
//!
//! This binary is called by agent-control-plane hooks to integrate with jj operations.
//!
//! # Usage
//!
//! ```bash
...
#[command(about = "Jujutsu hook integration for agent-control-plane")]
#[command(long_about = "CLI tool for integrating Jujutsu VCS with agent-control-plane hooks system")]
struct Cli {
