...
# Build container
/workspaces/agent-control-plane/archive/google-cloud-sdk/bin/gcloud builds submit \
    --tag gcr.io/agentic-llm/phi4-finetuning-gpu \
    --timeout=30m \
    -f cloudrun/Dockerfile.gpu .

# Deploy with env vars (no secrets needed)
/workspaces/agent-control-plane/archive/google-cloud-sdk/bin/gcloud run deploy phi4-finetuning-gpu \
