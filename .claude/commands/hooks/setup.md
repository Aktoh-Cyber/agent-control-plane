...
```bash
# Test pre-edit hook
npx gendev hook pre-edit --file test.js

# Test session summary
npx gendev hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "npx gendev hook pre-write --file '${tool.params.file_path}'"
          }
        ]
      }
    ]
...
# Test specific hook
npx gendev hook pre-edit --file app.js --debug
```
