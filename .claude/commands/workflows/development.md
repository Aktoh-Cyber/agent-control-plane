...
```
Tool: mcp__gendev__task_orchestrate
Parameters: {
...
npx gendev workflow dev "REST API with auth"

# Create custom workflow
npx gendev workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx gendev workflow execute api-dev
```
