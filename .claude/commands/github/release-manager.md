...
mcp__gendev__agent_spawn { type: "coordinator", name: "Release Coordinator" }
...
[Single Message - Complete Release Management]:
  ...
  mcp__gendev__swarm_init { topology: "star", maxAgents: 8 }
  mcp__gendev__agent_spawn { type: "coordinator", name: "Release Director" }
  mcp__gendev__agent_spawn { type: "tester", name: "QA Lead" }
  mcp__gendev__agent_spawn { type: "reviewer", name: "Senior Reviewer" }
  mcp__gendev__agent_spawn { type: "coder", name: "Version Controller" }
  mcp__gendev__agent_spawn { type: "analyst", name: "Performance Analyst" }
  ...
  release-validation:
    ...
    steps:
      ...
      - name: Validate Release
        run: npx gendev release validate
```
