...
npx gendev sparc run architect "design microservices"

# 2. Implementation
npx gendev sparc run coder "implement services"

# 3. Testing
npx gendev sparc run tdd "test all services"

# 4. Review
npx gendev sparc run reviewer "review implementation"
```
...
```bash
# 1. Research phase
npx gendev sparc run researcher "research best practices"

# 2. Innovation
npx gendev sparc run innovator "propose novel solutions"

# 3. Documentation
npx gendev sparc run documenter "document findings"
```
