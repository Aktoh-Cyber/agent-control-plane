...
npx gendev sparc run innovator "innovative solutions for scaling"

# For alpha features
npx gendev@alpha sparc run innovator "innovative solutions for scaling"
```
...
./gendev sparc run innovator "innovative solutions for scaling"
```
