...
npx gendev sparc run workflow-manager "automate deployment"

# For alpha features
npx gendev@alpha sparc run workflow-manager "automate deployment"
```
...
./gendev sparc run workflow-manager "automate deployment"
```
