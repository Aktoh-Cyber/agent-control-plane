...
npx gendev sparc run memory-manager "organize project knowledge"

# For alpha features
npx gendev@alpha sparc run memory-manager "organize project knowledge"
```
...
./gendev sparc run memory-manager "organize project knowledge"
```
