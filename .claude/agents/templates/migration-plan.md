...
# GenDev Commands to Agent System Migration Plan
...
tools:
  allowed:
    ...
    - mcp__gendev__swarm_init
    - mcp__gendev__agent_spawn
    - mcp__gendev__github_code_review
    - mcp__gendev__memory_usage
  restricted:
    - Write
    - Edit
...
tools:
  allowed:
    - Bash
    - Read
    - mcp__gendev__github_release_coord
    - mcp__gendev__swarm_init
    - mcp__gendev__task_orchestrate
    - TodoWrite
  restricted:
...
tools:
  allowed:
    ...
    - TodoWrite
  restricted:
    - mcp__gendev__swarm_init # Focus on implementation
triggers:
...
tools:
  allowed:
    ...
    - mcp__gendev__memory_compress
    - mcp__gendev__memory_sync
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__gendev__daa_agent_create
    - mcp__gendev__daa_capability_match
    - mcp__gendev__daa_resource_alloc
