...
npx gendev topology-analyze --swarm-id <id> --metrics performance

# Optimize topology automatically
npx gendev topology-optimize --swarm-id <id> --strategy adaptive

# Compare topology configurations
npx gendev topology-compare --topologies ["hierarchical", "mesh", "hybrid"]

# Generate topology recommendations
npx gendev topology-recommend --workload-profile <file> --constraints <file>

# Monitor topology performance
npx gendev topology-monitor --swarm-id <id> --interval 60
```
...
npx gendev placement-optimize --algorithm genetic --agents <agent-list>

# Analyze placement efficiency
npx gendev placement-analyze --current-placement <config>

# Generate placement recommendations
npx gendev placement-recommend --communication-patterns <file>
```
