...
npx gendev benchmark-run --suite throughput --iterations 10

# Compare with baseline
npx gendev benchmark-compare --current <results> --baseline <baseline>

# Quality assessment
npx gendev quality-assess --target swarm-performance --criteria throughput,latency

# Performance validation
npx gendev validate-performance --results <file> --criteria <file>
```
...
```bash
# Detect performance regressions
npx gendev detect-regression --current <results> --historical <data>

# Set up automated regression monitoring
npx gendev regression-monitor --enable --sensitivity 0.95

# Analyze error patterns
npx gendev error-analysis --logs <log-files>
```
