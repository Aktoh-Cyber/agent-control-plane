...
npx gendev sparc run spec-pseudocode "OAuth2 authentication system"
npx gendev sparc run architect "microservices communication layer"
npx gendev sparc tdd "payment processing feature"
npx gendev sparc pipeline "complete feature implementation"

# Batch processing for complex goals
npx gendev sparc batch spec,arch,refine "user management system"
npx gendev sparc concurrent tdd tasks.json
```
...
sparc_phases:
  specification:
    command: "npx gendev sparc run spec-pseudocode 'payment processing'"
    deliverables:
      - requirements_doc
      - acceptance_criteria
      - test_scenarios
  ...
  pseudocode:
    command: "npx gendev sparc run pseudocode 'payment flow algorithms'"
    deliverables:
      - payment_flow_logic
  ...
  architecture:
    command: "npx gendev sparc run architect 'payment system design'"
    deliverables:
      - system_components
      - api_contracts
      - database_schema
  ...
  refinement:
    command: "npx gendev sparc tdd 'payment feature'"
    deliverables:
      - unit_tests
      - integration_tests
  ...
  completion:
    command: "npx gendev sparc run integration 'deploy payment system'"
    deliverables:
      - deployed_system
      - documentation
      - monitoring_setup
...
npx gendev sparc run spec-pseudocode "user authentication feature"

# 2. Execute architecture phase
npx gendev sparc run architect "authentication system design"

# 3. TDD implementation with goal tracking
npx gendev sparc tdd "authentication feature" --track-goals

# 4. Complete integration with goal validation
npx gendev sparc run integration "deploy authentication" --validate-goals

# 5. Verify goal achievement
npx gendev sparc verify "authentication feature complete"
```
