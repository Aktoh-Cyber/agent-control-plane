...
- `mcp__github__create_pull_request`
- `mcp__github__search_repositories`
- `mcp__gendev__*` (all swarm coordination tools)
...
mcp__gendev__swarm_init { topology: "hierarchical", maxAgents: 5 }
mcp__gendev__agent_spawn { type: "coordinator", name: "Sync Coordinator" }
mcp__gendev__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__gendev__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__gendev__agent_spawn { type: "tester", name: "Validation Engineer" }
...
[Single Message - Complete Synchronization]:
  ...
  mcp__gendev__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
  mcp__gendev__agent_spawn { type: "analyst", name: "Package Analyzer" }
  mcp__gendev__agent_spawn { type: "coder", name: "Integration Coder" }
  mcp__gendev__agent_spawn { type: "tester", name: "Validation Tester" }
  mcp__gendev__agent_spawn { type: "reviewer", name: "Quality Reviewer" }
...
mcp__gendev__swarm_init { topology: "hierarchical", maxAgents: 10 }
mcp__gendev__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
mcp__gendev__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__gendev__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__gendev__agent_spawn { type: "tester", name: "Validation Engineer" }
mcp__gendev__agent_spawn { type: "reviewer", name: "Quality Assurance" }
mcp__gendev__agent_spawn { type: "monitor", name: "Sync Monitor" }
...
mcp__gendev__agent_spawn { type: "monitor", name: "Error Monitor" }
mcp__gendev__agent_spawn { type: "analyst", name: "Failure Analyzer" }
mcp__gendev__agent_spawn { type: "coder", name: "Recovery Developer" }

# Coordinate recovery procedures
mcp__gendev__coordination_sync { swarmId: "error-recovery-swarm" }
