...
mcp__gendev__swarm_init { topology: "mesh", maxAgents: 12 }
mcp__gendev__agent_spawn { type: "coordinator", name: "Workflow Coordinator" }
mcp__gendev__agent_spawn { type: "architect", name: "Pipeline Architect" }
mcp__gendev__agent_spawn { type: "coder", name: "Workflow Developer" }
mcp__gendev__agent_spawn { type: "tester", name: "CI/CD Tester" }
mcp__gendev__agent_spawn { type: "optimizer", name: "Performance Optimizer" }
mcp__gendev__agent_spawn { type: "monitor", name: "Automation Monitor" }
mcp__gendev__agent_spawn { type: "analyst", name: "Workflow Analyzer" }
