...
- Node.js 18+
- AgentDB v1.0.7+ (via agent-control-plane or standalone)
...
```typescript
import { createAgentDBAdapter } from 'agent-control-plane/reasoningbank';
...
```typescript
import { createAgentDBAdapter, migrateToAgentDB } from 'agent-control-plane/reasoningbank';
...
- GitHub: https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/packages/agentdb
- Documentation: node_modules/agent-control-plane/docs/AGENTDB_INTEGRATION.md
