...
SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) is a systematic development methodology integrated with GenDev's multi-agent orchestration capabilities. It provides 17 specialized modes for comprehensive software development, from initial research through deployment and monitoring.
...
npx gendev sparc run <mode> "task description"

# Use alpha features
npx gendev@alpha sparc run <mode> "task description"

# List all available modes
npx gendev sparc modes

# Get help for specific mode
npx gendev sparc help <mode>

# Run with options
npx gendev sparc run <mode> "task" --parallel --monitor

# Execute TDD workflow
npx gendev sparc tdd "feature description"

# Batch execution
npx gendev sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx gendev sparc pipeline "task description"
```

### Method 3: Local Installation

**Best for**: Projects with local gendev installation

```bash
# If gendev is installed locally
./gendev sparc run <mode> "task description"
```
...
mcp__gendev__agent_spawn { type: "architect" }
mcp__gendev__agent_spawn { type: "coder" }
mcp__gendev__agent_spawn { type: "tester" }
mcp__gendev__agent_spawn { type: "reviewer" }
```
...
[Single Message]:
  mcp__gendev__agent_spawn { type: "researcher" }
  mcp__gendev__agent_spawn { type: "coder" }
  mcp__gendev__agent_spawn { type: "tester" }
  TodoWrite { todos: [8-10 todos] }

// ❌ WRONG: Multiple messages
Message 1: mcp__gendev__agent_spawn { type: "researcher" }
Message 2: mcp__gendev__agent_spawn { type: "coder" }
...
```bash
# Before work
npx gendev@alpha hooks pre-task --description "implement auth"

# During work
npx gendev@alpha hooks post-edit --file "auth.js"

# After work
npx gendev@alpha hooks post-task --task-id "task-123"
```
...
npx gendev sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx gendev sparc run architect "design auth system"

# Step 3: TDD implementation
npx gendev sparc tdd "user authentication feature"

# Step 4: Code review
npx gendev sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx gendev sparc run documenter "document auth API"
```
...
npx gendev sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx gendev sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx gendev sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx gendev sparc run reviewer "validate bug fix"
```
...
npx gendev sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx gendev sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx gendev sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx gendev sparc run tester "performance benchmarks"
```
...
npx gendev sparc pipeline "e-commerce checkout feature"
...
```javascript
// Analyze repository
mcp__gendev__github_repo_analyze {
  repo: "owner/repo",
  analysis_type: "code_quality"
}

// Manage pull requests
mcp__gendev__github_pr_manage {
  repo: "owner/repo",
  pr_number: 123,
  action: "review"
}
...
- **Documentation**: https://github.com/tafyai/gendev
- **Issues**: https://github.com/tafyai/gendev/issues
- **NPM Package**: https://www.npmjs.com/package/gendev
...
# Run specific mode
npx gendev sparc run <mode> "task"

# TDD workflow
npx gendev sparc tdd "feature"

# Full pipeline
npx gendev sparc pipeline "task"

# Batch execution
npx gendev sparc batch <modes> "task"
```
...
// Execute mode
mcp__gendev__sparc_mode { mode: "coder", task_description: "..." }

// Monitor progress
mcp__gendev__swarm_monitor { interval: 5000 }

// Store in memory
mcp__gendev__memory_usage { action: "store", key: "...", value: "..." }
```
