---
name: agentic-cloud-platform
description: Comprehensive Agentic Cloud platform management - authentication, sandboxes, app deployment, payments, and challenges
category: platform
version: 1.0.0
author: Agentic Cloud
tags: [authentication, sandboxes, deployment, payments, gamification, cloud]
---

# Agentic Cloud Platform Management

Comprehensive platform management for Agentic Cloud - covering authentication, sandbox execution, app deployment, credit management, and coding challenges.
...
```javascript
mcp__agentic -
  cloud__app_store_list_templates({
    category: 'web-api',
...
```javascript
mcp__agentic - cloud__market_data();
```
...
- Withdraw credits or use for Agentic Cloud services
...
```javascript
mcp__agentic -
  cloud__app_store_complete_challenge({
    challenge_id: 'challenge_id',
    user_id: 'your_user_id',
    submission_data: {
      passed_tests: 10,
...
mcp__agentic -
  cloud__execution_stream_subscribe({
    stream_type: 'gendev-swarm', // claude-code, gendev-swarm, gendev-hive-mind, github-integration
...
mcp__agentic -
  cloud__execution_files_list({
    stream_id: 'stream_id',
    created_by: 'gendev', // claude-code, gendev, git-clone, user
...
mcp__agentic -
  cloud__sandbox_execute({
    ...
    code: 'console.log("Hello Agentic Cloud!")',
    language: 'javascript',
  });
```
...
- **Documentation**: https://docs.agentic-cloud.tafy.io
- **API Reference**: https://api.agentic-cloud.tafy.io/docs
- **Status Page**: https://status.agentic-cloud.tafy.io
- **Community Forum**: https://community.agentic-cloud.tafy.io
- **GitHub Issues**: https://github.com/tafyai/agentic-cloud/issues
- **Discord**: https://discord.gg/agentic-cloud
- **Email Support**: support@agentic-cloud.tafy.io (Pro/Enterprise only)
...
_This skill consolidates 6 Agentic Cloud command modules into a single comprehensive platform management interface._
