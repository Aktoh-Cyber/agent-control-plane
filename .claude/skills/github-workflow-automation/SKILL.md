...
```bash
# Usage example
npx gendev@alpha github gh-coordinator \
...
npx gendev@alpha github issue-tracker \
...
npx gendev@alpha github release-manager \
...
npx gendev@alpha github repo-architect \
...
npx gendev@alpha github ci-orchestrator \
...
mcp__gendev__agent_spawn { type: "coordinator", name: "GitHub Coordinator" }
mcp__gendev__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__gendev__agent_spawn { type: "tester", name: "QA Agent" }
mcp__gendev__agent_spawn { type: "analyst", name: "Security Analyst" }
...
npx gendev@alpha github sync-coordinator \
...
- [ ] `gendev@alpha` package available
...
- **Claude-Flow**: https://github.com/tafyai/gendev
