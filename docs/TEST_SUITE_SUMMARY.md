...
**Type Definitions** (`/home/user/agent-control-plane/src/types/medical.ts`)
...
**Services** (`/home/user/agent-control-plane/src/services/`)
...
**CLI Interface** (`/home/user/agent-control-plane/src/cli/medical-cli.ts`)
...
**API Handlers** (`/home/user/agent-control-plane/src/api/medical-api.ts`)
...
**Middleware** (`/home/user/agent-control-plane/src/middleware/agentdb-integration.ts`)
...
1. `/home/user/agent-control-plane/tests/unit/cli.test.ts` - CLI command testing
2. `/home/user/agent-control-plane/tests/unit/api.test.ts` - API endpoint testing
3. `/home/user/agent-control-plane/tests/unit/mcp-tools.test.ts` - MCP tool testing
4. `/home/user/agent-control-plane/tests/unit/verification.test.ts` - Verification system testing
5. `/home/user/agent-control-plane/tests/unit/notification.test.ts` - Notification system testing

#### Integration Tests (2 files, ~40 test cases)

6. `/home/user/agent-control-plane/tests/integration/end-to-end.test.ts` - Complete workflows
7. `/home/user/agent-control-plane/tests/integration/provider-notification-flow.test.ts` - Notification flows

#### Validation Tests (3 files, ~50 test cases)

8. `/home/user/agent-control-plane/tests/validation/medical-accuracy.test.ts` - Medical accuracy
9. `/home/user/agent-control-plane/tests/validation/confidence-scoring.test.ts` - Confidence scoring
10. `/home/user/agent-control-plane/tests/validation/citation-verification.test.ts` - Citation verification

#### Safety Tests (4 files, ~40 test cases)

11. `/home/user/agent-control-plane/tests/safety/hallucination-detection.test.ts` - Hallucination detection
12. `/home/user/agent-control-plane/tests/safety/edge-cases.test.ts` - Edge case handling
13. `/home/user/agent-control-plane/tests/safety/error-recovery.test.ts` - Error recovery
14. `/home/user/agent-control-plane/tests/safety/security-validation.test.ts` - Security validation

### Support Files

15. `/home/user/agent-control-plane/jest.config.medical.cjs` - Jest configuration
16. `/home/user/agent-control-plane/tests/tsconfig.json` - TypeScript configuration
17. `/home/user/agent-control-plane/tests/test-helper.ts` - Test utilities
18. `/home/user/agent-control-plane/tests/README.md` - Test documentation
19. `/home/user/agent-control-plane/tests/RUN_TESTS.md` - Execution guide
20. `/home/user/agent-control-plane/docs/MEDICAL_ANALYSIS_TEST_SUITE.md` - Comprehensive documentation
...
```
/home/user/agent-control-plane/src/
├── types/medical.ts
├── services/
│   ├── medical-analyzer.ts
...
```
/home/user/agent-control-plane/tests/
├── unit/ (5 files)
├── integration/ (2 files)
├── validation/ (3 files)
├── safety/ (4 files)
...
```
/home/user/agent-control-plane/docs/
