...
[← Back to Main README](https://github.com/Aktoh-Cyber/agent-control-plane/blob/main/README.md) | [ReasoningBank →](https://github.com/Aktoh-Cyber/agent-control-plane/blob/main/docs/guides/REASONINGBANK.md) | [Multi-Model Router →](https://github.com/Aktoh-Cyber/agent-control-plane/blob/main/docs/guides/MULTI-MODEL-ROUTER.md)
...
```bash
npx agent-control-plane agent-booster edit \
  --file src/api.ts \
...
```bash
npx agent-control-plane agent-booster batch \
...
```bash
# Install agent-control-plane (includes Agent Booster)
npm install -g agent-control-plane

# Verify installation
npx agent-control-plane agent-booster --version
...
Agent Booster is available as an MCP tool within agent-control-plane:
...
```bash
npx agent-control-plane agent-booster batch-rename \
  --pattern "getUserData" \
...
```bash
npx agent-control-plane agent-booster [command] [options]
...
Agent Booster is part of the agent-control-plane project. Contributions welcome!
