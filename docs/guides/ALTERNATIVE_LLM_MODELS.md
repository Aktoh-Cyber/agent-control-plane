...
OPENROUTER_SITE_URL=https://github.com/Aktoh-Cyber/agent-control-plane
OPENROUTER_APP_NAME=agent-control-plane
```
...
```json
{
  "fallback": {
    "enabled": true,
    "chain": ["onnx", "openrouter", "anthropic"],
    "retryAttempts": 3,
    "backoffMs": 1000
  }
}
...
**Created by @ruvnet**
For issues: https://github.com/Aktoh-Cyber/agent-control-plane/issues
