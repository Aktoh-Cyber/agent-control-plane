...
[← Back to Main README](https://github.com/Aktoh-Cyber/agent-control-plane/blob/main/README.md) | [Agent Booster ←](https://github.com/Aktoh-Cyber/agent-control-plane/blob/main/docs/guides/AGENT-BOOSTER.md) | [Multi-Model Router →](https://github.com/Aktoh-Cyber/agent-control-plane/blob/main/docs/guides/MULTI-MODEL-ROUTER.md)
...
await reasoningBank.storeExperience({
  ...
  patterns: ['timeout-handling', 'authentication-security', 'error-recovery'],
});
...
```bash
# Install agent-control-plane (includes ReasoningBank)
...
const { ReasoningOptimizedAgent } = require('agent-control-plane');
...
await reasoningBank.provideFeedback({
  ...
  appliedPatterns: ['oauth2-express-pattern', 'jwt-token-handling'],
  outcome: 'success',
  metrics: {
...
- [ReasoningBank Implementation](https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/agent-control-plane/src/reasoningbank)
- [Pattern Matching Engine](https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/agent-control-plane/src/reasoningbank/pattern-matcher.js)
- [Experience Curator](https://github.com/Aktoh-Cyber/agent-control-plane/tree/main/agent-control-plane/src/reasoningbank/experience-curator.js)

### Integrations

- [Claude Agent SDK](https://docs.claude.com/en/api/agent-sdk)
- [GenDev (101 MCP tools)](https://github.com/tafyai/gendev)
- [Agentic Cloud (96 cloud tools)](https://github.com/tafyai/agentic-cloud)

---

## 🤝 Contributing

ReasoningBank is part of the agent-control-plane project. Contributions welcome!
