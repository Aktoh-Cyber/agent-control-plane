...
```bash
# 1. GenDev - Core orchestration (required)
claude mcp add gendev npx gendev@alpha mcp start

# 2. Agentic Cloud - Cloud features (optional, requires registration)
claude mcp add agentic-cloud npx agentic-cloud@latest mcp start

# 3. Agentic Payments - Payment authorization (optional)
# Built-in with agent-control-plane, auto-detected

# 4. Agentic Flow - Agent execution (optional)
claude mcp add agent-control-plane npx agent-control-plane@latest mcp start
...
| -------------------- | ------------- | ---------- | --------------------------------------------------------- |
| **GenDev**           | ❌ No         | 0 min      | Ready to use                                              |
| **AgentDB**          | ❌ No (local) | 0 min      | Built-in with GenDev                                      |
| **Agentic Flow**     | ❌ No         | 0 min      | Built-in package                                          |
| **Agentic Cloud**    | ✅ Yes        | 2 min      | [Auth Guide](./MCP-AUTHENTICATION.md)                     |
| **Agentic Payments** | ✅ Keypair    | 1 min      | [Payment Setup](./MCP-AUTHENTICATION.md#agentic-payments) |

### Quick Authentication Setup

**Agentic Cloud (for cloud features):**
...
| -------------------- | ----- | ------------------------------------- | ------------ | ----------------------------------------------------------------------------- |
| **GenDev**           | 46    | Orchestration, memory, neural         | None         | `claude mcp add gendev npx gendev@alpha mcp start`                            |
| **AgentDB**          | 9     | Advanced memory, causal learning      | None (local) | Built-in with GenDev                                                          |
| **Agentic Cloud**    | 70+   | Cloud execution, sandboxes, templates | Required     | `claude mcp add agentic-cloud npx agentic-cloud@latest mcp start`             |
| **Agentic Payments** | 10    | Payment authorization, mandates       | Keypair      | Built-in with agent-control-plane                                             |
| **Agentic Flow**     | ~10   | Agent execution, optimization         | None         | `claude mcp add agent-control-plane npx agent-control-plane@latest mcp start` |
...
| [2. Swarm & Agent Orchestration](#2%EF%B8%8F⃣-swarm--agent-orchestration-26-tools) | 26    | GenDev                | No            |
| [3. Memory & Learning](#3%EF%B8%8F⃣-memory--learning-20-tools)                     | 20    | GenDev                | No            |
| [4. Neural Networks & AI](#4%EF%B8%8F⃣-neural-networks--ai-15-tools)               | 15    | GenDev, Agentic Cloud | Mixed         |
| [5. Cloud Execution & Sandboxes](#5%EF%B8%8F⃣-cloud-execution--sandboxes-24-tools) | 24    | Agentic Cloud         | Yes           |
| [6. GitHub Integration](#6%EF%B8%8F⃣-github-integration-16-tools)                  | 16    | GenDev                | No            |
| [7. Payment Authorization](#7%EF%B8%8F⃣-payment-authorization-10-tools)            | 10    | Agentic Payments      | Keypair       |
| [8. Workflow Automation](#8%EF%B8%8F⃣-workflow-automation-22-tools)                | 22    | Agentic Cloud         | Yes           |
| [9. Performance & Monitoring](#9%EF%B8%8F⃣-performance--monitoring-18-tools)       | 18    | GenDev                | No            |
| [10. App Store & Templates](#-app-store--templates-12-tools)                       | 12    | Agentic Cloud         | Yes           |
...
Execute code in isolated cloud environments (Agentic Cloud).

**⚠️ Authentication Required:** [Setup Guide](./MCP-AUTHENTICATION.md#agentic-cloud)
...
Event-driven workflow execution with message queues (Agentic Cloud).
...
Deploy pre-built applications and templates (Agentic Cloud).
...
| ---------------------- | --------------- | ----------- | ----------- | ------------- |
| **Memory Operations**  | 5ms             | 12ms        | 10K ops/sec | GenDev        |
| **Swarm Management**   | 50ms            | 120ms       | 500 ops/sec | GenDev        |
| **Neural Inference**   | 15ms            | 35ms        | 2K ops/sec  | GenDev        |
| **Sandbox Creation**   | 2s              | 5s          | 50 ops/min  | Agentic Cloud |
| **GitHub Integration** | 200ms           | 800ms       | 100 ops/sec | GenDev        |
...
- [Authentication Setup](./MCP-AUTHENTICATION.md) - Agentic Cloud & Agentic Payments auth
...
MCP tools are part of the agent-control-plane ecosystem. Contributions welcome!
