...
This guide will help you get started with QUIC-enabled multi-agent swarm coordination in agent-control-plane.
...
1. Check WASM module is loaded:
   ...
   ```typescript
   import { checkQuicAvailability } from 'agent-control-plane';
...
- Examples: https://github.com/Aktoh-Cyber/agent-control-plane/examples
