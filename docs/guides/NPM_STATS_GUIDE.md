...
# Specific fields
npm view agent-control-plane name version description

# All versions
npm view agent-control-plane versions

# As JSON
npm view agent-control-plane --json

# Package metadata
npm info agent-control-plane
```
...
```bash
# Last day
curl https://api.npmjs.org/downloads/point/last-day/agent-control-plane

# Last week
curl https://api.npmjs.org/downloads/point/last-week/agent-control-plane

# Last month
curl https://api.npmjs.org/downloads/point/last-month/agent-control-plane

# Last year
curl https://api.npmjs.org/downloads/point/last-year/agent-control-plane

# Date range
curl https://api.npmjs.org/downloads/range/2024-01-01:2024-12-31/agent-control-plane
```
...
./scripts/npm-stats.sh agent-control-plane
...
```bash
# Download stats
npx npm-stats agent-control-plane

# With date range
npx npm-stats agent-control-plane --start-date 2024-01-01

# Package details
npx package-stats agent-control-plane
```
...
**Created**: 2025-10-21
**Location**: `/home/user/agent-control-plane/scripts/`
