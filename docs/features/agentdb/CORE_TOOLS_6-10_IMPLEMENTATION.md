...
- Location: `/workspaces/agent-control-plane/packages/agentdb/src/mcp/agentdb-mcp-server.ts` (lines 1134-1193)
...
**File:** `/workspaces/agent-control-plane/packages/agentdb/src/controllers/ReasoningBank.ts`
...
# Via MCP
mcp__agent-control-plane__agentdb_pattern_store {
...
mcp__agent-control-plane__agentdb_pattern_search {
...
mcp__agent-control-plane__agentdb_pattern_stats {}

# Get detailed database statistics
mcp__agent-control-plane__agentdb_stats { "detailed": true }
```
...
```bash
# Clear all caches
mcp__agent-control-plane__agentdb_clear_cache { "cache_type": "all" }

# Clear only pattern cache
mcp__agent-control-plane__agentdb_clear_cache { "cache_type": "patterns" }
```
...
- MCP Server: `/workspaces/agent-control-plane/packages/agentdb/src/mcp/agentdb-mcp-server.ts`
- ReasoningBank: `/workspaces/agent-control-plane/packages/agentdb/src/controllers/ReasoningBank.ts`
- EmbeddingService: `/workspaces/agent-control-plane/packages/agentdb/src/controllers/EmbeddingService.ts`
