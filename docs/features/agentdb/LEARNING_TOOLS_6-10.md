...
```json
{
  ...
  "groupedMetrics": [{ "key": "task_name", "count": 50, "avgReward": 0.8, "successRate": 0.9 }],
  "trends": [{ "date": "2025-10-15", "count": 10, "avgReward": 0.7, "successRate": 0.8 }],
  "policyImprovement": {
    "versions": 5,
...
```json
{
  ...
  "transferred": {
    ...
    "skills": 12,
    "causalEdges": 5,
    "details": [{ "type": "episode", "id": 123, "similarity": 0.85 }]
  },
...
```json
{
  ...
  "causalChains": [{ "fromMemoryType": "add_index", "toMemoryType": "fast_query", "uplift": 0.45 }]
}
```
...
**File:** `/workspaces/agent-control-plane/packages/agentdb/src/controllers/LearningSystem.ts`
...
**File:** `/workspaces/agent-control-plane/packages/agentdb/src/mcp/agentdb-mcp-server.ts`
