...
'/workspaces/agent-control-plane/agent-control-plane/node_modules/agentdb/dist/index.js'
```
...
- [Federated AgentDB Architecture](/workspaces/agent-control-plane/docs/architecture/FEDERATED-AGENTDB-EPHEMERAL-AGENTS.md)
- [Data Lifecycle Explanation](/workspaces/agent-control-plane/docs/architecture/FEDERATION-DATA-LIFECYCLE.md)
- [Multi-Agent Test Report](/workspaces/agent-control-plane/docs/architecture/FEDERATION-TEST-REPORT.md)

### Source Code

- [FederationHubServer.ts](/workspaces/agent-control-plane/agent-control-plane/src/federation/FederationHubServer.ts)
- [EphemeralAgent.ts](/workspaces/agent-control-plane/agent-control-plane/src/federation/EphemeralAgent.ts)
- [Multi-Agent Collaboration Test](/workspaces/agent-control-plane/agent-control-plane/tests/federation/test-agentdb-collaboration.ts)

### Related Projects

- [AgentDB Package](/workspaces/agent-control-plane/packages/agentdb) - Vector memory storage
- [Agentic Flow](https://github.com/Aktoh-Cyber/agent-control-plane) - Main repository
