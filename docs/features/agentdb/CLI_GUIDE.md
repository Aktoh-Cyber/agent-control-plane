...
# or
npx agent-control-plane agentdb <command>
```
...
sqlite3 agentdb.db < agent-control-plane/src/agentdb/schemas/frontier-schema.sql
```
...
- [AgentDB README](../../agent-control-plane/src/agentdb/README.md) - Architecture overview
- [Optimization Guide](../../agent-control-plane/src/agentdb/OPTIMIZATION_GUIDE.md) - Performance tuning
- [Frontier Validation](../../agent-control-plane/src/agentdb/docs/FRONTIER_FEATURES_VALIDATION.md) - Test results

---

**Need help?** Open an issue at https://github.com/Aktoh-Cyber/agent-control-plane/issues
