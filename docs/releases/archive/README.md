...
This directory contains release notes, publication reports, and version-specific documentation for agent-control-plane releases.
...
agent-control-plane follows [Semantic Versioning](https://semver.org/):
