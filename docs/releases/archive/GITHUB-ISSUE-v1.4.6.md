# 🧠 agent-control-plane v1.4.6: ReasoningBank - Agents That Learn From Experience

## 🎯 Introduction (200 words)

We're thrilled to announce **agent-control-plane v1.4.6**, featuring **ReasoningBank** - a breakthrough memory system that transforms AI agents from stateless executors into continuously learning systems. Based on cutting-edge research from Google DeepMind (arXiv:2509.25140), ReasoningBank enables agents to remember successful strategies, learn from both successes and failures, and improve performance exponentially over time.
...
```typescript
import { runTask } from 'agent-control-plane/reasoningbank';
...
```typescript
import { runTask, consolidate } from 'agent-control-plane/reasoningbank';
...
import { getMemoryStatistics } from 'agent-control-plane/reasoningbank';
...
```typescript
import { runTask, mattsParallel } from 'agent-control-plane/reasoningbank';
...
```typescript
import { runTask, retrieveMemories, distillSuccess } from 'agent-control-plane/reasoningbank';
...
```typescript
import { runTask, mattsSequential, consolidate } from 'agent-control-plane/reasoningbank';
...
const incidentMemories = await retrieveMemories('High memory usage causing pod crashes', {
  domain: 'sre.incident-response',
  k: 5,
});
...
npm install -g agent-control-plane@1.4.6
...
npx agent-control-plane reasoningbank benchmark
...
1. **[ReasoningBank README](../agent-control-plane/src/reasoningbank/README.md)** (556 lines)
   - Simple introduction with value proposition
   - Full implementation guide
   - API reference and usage examples
   - Performance benchmarks

2. **[Demo Comparison Report](../agent-control-plane/docs/REASONINGBANK-DEMO.md)** (420 lines)
   - Side-by-side visual comparison
   - Technical details (4-factor scoring, MMR)
   - Memory lifecycle diagrams
   - Real-world impact calculations

3. **[CLI Integration Guide](../agent-control-plane/docs/REASONINGBANK-CLI-INTEGRATION.md)** (456 lines)
...
- **NPM Package:** [npmjs.com/package/agent-control-plane](https://www.npmjs.com/package/agent-control-plane)
- **GitHub Repository:** [github.com/Aktoh-Cyber/agent-control-plane](https://github.com/Aktoh-Cyber/agent-control-plane)
...
- **Full Documentation:** [docs/reasoningbank](../agent-control-plane/src/reasoningbank/)
- **Architecture Guide:** [docs/architecture/RESEARCH_SUMMARY.md](../agent-control-plane/docs/architecture/RESEARCH_SUMMARY.md)

### Related Projects

- **GenDev:** [github.com/tafyai/gendev](https://github.com/tafyai/gendev) - 101 MCP tools for agent orchestration
- **Agentic Cloud:** [github.com/tafyai/agentic-cloud](https://github.com/tafyai/agentic-cloud) - Cloud sandbox execution
...
- **Paper:** _"ReasoningBank: Scaling Agent Self-Evolving with Reasoning Memory"_
...
- [GenDev](https://github.com/tafyai/gendev) MCP tools
...
- **GitHub Issues:** [Report bugs or request features](https://github.com/Aktoh-Cyber/agent-control-plane/issues)
- **GitHub Discussions:** [Ask questions and share use cases](https://github.com/Aktoh-Cyber/agent-control-plane/discussions)
- **Documentation:** [Full guides and API reference](../agent-control-plane/src/reasoningbank/)
...
_Generated with [agent-control-plane v1.4.6](https://github.com/Aktoh-Cyber/agent-control-plane)_
