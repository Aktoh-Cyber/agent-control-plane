...
```json
{
  ...
  "supported_models": ["Phi-3 Mini (3.8B)", "Phi-4 (14B)", "Llama 3.2 (1B, 3B)", "Gemma 2B"],
  "benefits": {
    "cost": "$0 (free)",
    "privacy": "100% local",
    "latency": "50-500ms",
...
npx agent-control-plane --agent coder --task "Create Python REST API"
# Cost: $0 (free tier)
# Time: ~3s
```
...
npx agent-control-plane --agent coder --task "Write hello world"
# Cost: $0
# Time: <1s
# Privacy: 100% local
```
...
For support: https://github.com/Aktoh-Cyber/agent-control-plane/issues
Created by: @ruvnet
