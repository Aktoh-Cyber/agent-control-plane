...
npx gendev@alpha swarm init --topology mesh --max-agents 4

npx gendev@alpha agent spawn --type coder --name "math-dev" \
  --task "Implement math.rs module"

npx gendev@alpha agent spawn --type coder --name "eraser-dev" \
  --task "Implement eraser.rs module"

npx gendev@alpha agent spawn --type coder --name "duality-dev" \
...
npx gendev@alpha hooks session-end --export-metrics
```
