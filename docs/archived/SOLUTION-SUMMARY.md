...
- `npx agentdb@latest` and `npx agent-control-plane@latest` failed in environments without build tools
...
### Agentic-Flow agent-control-plane/package.json
