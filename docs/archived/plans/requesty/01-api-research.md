...
For agent-control-plane integration, we only need **Chat Completions**.
...
HTTP-Referer: https://github.com/Aktoh-Cyber/agent-control-plane  # Optional
...
### With Existing agent-control-plane Architecture
