...
The agent-control-plane system integrates with multiple MCP servers:

### Primary MCP Server

- **gendev** - Core coordination and orchestration
...
- **agentic-cloud** - Cloud-based orchestration (requires authentication)
