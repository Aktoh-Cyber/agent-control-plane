...
const enhanced = learning.enhance(queryEmbedding, neighborEmbeddings, neighborWeights);
...
// Find similar skills
const skills = await skillLibrary.findSimilarSkills('How to deploy with Kubernetes?', 5);
```
