...
import {
  ...
  SubscriptionTier,
  UsageMetric,
} from '../../agent-control-plane/src/billing/index.js';
import { createBillingMCPTools } from '../../agent-control-plane/src/billing/mcp/tools.js';
...
class IntegrationValidator {
  ...
  private async validateCLIInterface(): Promise<void> {
    ...
    try {
      ...
      const { BillingCLI } = await import('../../agent-control-plane/src/billing/cli.js');
