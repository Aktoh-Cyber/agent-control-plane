...
const ENVIRONMENTAL_STRESS_EVENTS = [
  {
    ...
    duration: 2,
    description:
      'Severe famine in Finland caused by crop failures and harsh winters. Approximately 15% of the population died.',
  },
  {
    eventID: 'DHW_1944',
    ...
    duration: 0.5,
    description:
      'Acute famine during World War II caused by German blockade. Well-documented epigenetic effects on offspring.',
  },
  {
    eventID: 'SOL_1941',
    ...
    duration: 3,
    description:
      'Prolonged siege during World War II resulting in severe starvation. Extreme mortality and documented long-term health effects.',
  },
  {
    eventID: 'BF_1974',
    ...
    duration: 1,
    description:
      'Famine caused by flooding and political instability. Significant impact on maternal and child health.',
  },
];
...
const CAUSAL_RELATIONSHIPS = [
  ...
  },
  {
    ...
    pValue: 0.002,
    sampleSize: 456,
    evidence: ['Dutch Hunger Winter biomarker study', 'Contemporary famine cohort measurements'],
