...
_Statement_: For any feasible initial state and admissible control, the energy allocation remains feasible for all time.
...
_Statement_: The survival probability is monotonically decreasing and bounded between 0 and 1.
...
_Statement_: Under the structural causal model, increased parity causes decreased longevity through telomere attrition.
...
_Statement_: The optimal allocation policy satisfies the Hamilton-Jacobi-Bellman equation.
