...
describe('Medical Accuracy Validation', () => {
  ...
  describe('Diagnosis accuracy', () => {
    it('should diagnose hypertension based on blood pressure', async () => {
      ...
      expect(
        analysis.diagnosis.some(
          (d) =>
            d.toLowerCase().includes('hypertension') || d.toLowerCase().includes('blood pressure')
        )
      ).toBe(true);
    });
    ...
    it('should diagnose respiratory infection from symptoms', async () => {
      ...
      expect(
        analysis.diagnosis.some(
          (d) => d.toLowerCase().includes('respiratory') || d.toLowerCase().includes('infection')
        )
      ).toBe(true);
    });
    ...
    it('should identify diabetes risk factors', async () => {
      ...
      const diabetesRisk = analysis.riskFactors.find(
        (r) =>
    ...
    it('should recommend follow-up for new diagnoses', async () => {
      ...
      expect(
        analysis.recommendations.some(
          (r) => r.toLowerCase().includes('follow') || r.toLowerCase().includes('monitor')
        )
      ).toBe(true);
    });
  ...
  describe('Medical terminology validation', () => {
    it('should use proper medical terminology', async () => {
      ...
      const medicalTermPattern =
        /patient|symptoms?|diagnosis|treatment|medication|condition|vital signs?/i;
