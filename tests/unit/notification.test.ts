...
import { MedicalAnalysis } from '../../src/types/medical';
...
describe('NotificationService', () => {
  ...
  describe('notifyProvider', () => {
    it('should send multiple notifications for urgent cases', async () => {
      const urgentAnalysis: MedicalAnalysis = {
        ...mockAnalysis,
        riskFactors: [{ factor: 'Critical condition', severity: 'critical', confidence: 0.95 }],
      };
    ...
    it('should determine priority based on risk factors', async () => {
      const highRiskAnalysis: MedicalAnalysis = {
        ...mockAnalysis,
        riskFactors: [{ factor: 'High risk factor', severity: 'high', confidence: 0.9 }],
      };
  ...
  describe('channel selection', () => {
    it('should use all channels for urgent priority', async () => {
      const urgentAnalysis: MedicalAnalysis = {
        ...mockAnalysis,
        riskFactors: [{ factor: 'Critical', severity: 'critical', confidence: 0.99 }],
      };
