...
describe('Hallucination Detection', () => {
  ...
  describe('Logical consistency checks', () => {
    it('should detect logical contradictions', async () => {
      const data = {
        analysis:
          'Patient has high blood pressure however blood pressure is normal but not elevated',
    ...
    it('should accept logically consistent analysis', async () => {
      const data = {
        analysis:
          'Patient presents with elevated blood pressure readings consistently above 140/90',
        diagnosis: ['Hypertension'],
        citations: [
          {
            source: 'Journal',
  ...
  describe('Medical guideline compliance', () => {
    ...
    it('should flag guideline violations', async () => {
      const data = {
        analysis:
          'Patient should stop taking all medications immediately without consulting doctor',
