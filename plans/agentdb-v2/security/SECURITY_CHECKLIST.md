...
export function validateVector(embedding: Float32Array, expectedDim: number): void {
...
export async function secureWrite(filePath: string, data: Buffer, baseDir: string): Promise<void> {
...
export function enforceLimit(value: number, limit: number, name: string): void {
  if (value > limit) {
...
export function executeCypher(cypher: string, params: Record<string, any>): Promise<any> {
