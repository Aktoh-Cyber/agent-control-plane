...
This document compares RuVector with the current AgentDB implementation in agent-control-plane to help guide integration decisions.
...
For agent-control-plane, we recommend a **phased migration**:
