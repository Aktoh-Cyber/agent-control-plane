...
[![Build Status](https://img.shields.io/github/actions/workflow/status/Aktoh-Cyber/agent-control-plane/ci.yml?style=flat-square)](https://github.com/Aktoh-Cyber/agent-control-plane/actions)
